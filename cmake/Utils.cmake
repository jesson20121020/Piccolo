...
macro(project_begin)
	...
	set(PROJECT_SOURCE_INCLUDES)
	set(PROJECT_SOURCE_EXCLUDES)
	set(PROJECT_INCLUDE_DIRS)
	set(PROJECT_DEFINITIONS)
	set(PROJECT_DEPENDS)
	set(PROJECT_DEPEND_EXTERNALS)
	set(PROJECT_TYPE ${PROJECT_TYPE_LIBRARY})
endmacro()
...
macro(project_end)
	...
	if (PROJECT_TYPE STREQUAL PROJECT_TYPE_PRECOMPILED)
		foreach(lib ${PROJECT_PRECOMPILED_LIBS})
			list(APPEND additional_libs "${PROJECT_SOURCE_DIR}/${lib}")
		endforeach()
		...
		if(libs_length EQUAL 0)
			...
			foreach(file ${FILES})
				list(APPEND additional_libs "${file}")
			endforeach()
		endif()
		# set copy bins
	...
	foreach(depend_project ${PROJECT_DEPENDS})
		...
		list(APPEND additional_libs "${${depend_project}_libs}")
	endforeach()
	...
	foreach(depend_external ${PROJECT_DEPEND_EXTERNALS})
		...
		list(APPEND additional_libs "${${depend_external}_libs}")
	endforeach()

	set(${PROJECT_NAME}_includes "${additional_includes}" CACHE STRING "${PROJECT_NAME} Include Find Directory")
	set(${PROJECT_NAME}_libs "${additional_libs}" CACHE STRING "${PROJECT_NAME} Link Libs")
	...
	if (PROJECT_TYPE STREQUAL PROJECT_TYPE_PRECOMPILED)
		...
		target_link_libraries(${PROJECT_NAME} LINK_PUBLIC ${PROJECT_DEPENDS} ${additional_libs})
	endif()
endmacro()