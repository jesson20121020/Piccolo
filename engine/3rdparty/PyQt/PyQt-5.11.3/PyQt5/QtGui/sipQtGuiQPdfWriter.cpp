...
PyDoc_STRVAR(doc_QPdfWriter_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QPdfWriter_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QPdfWriter_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QPdfWriter_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QPdfWriter_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QPdfWriter_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPdfWriter_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPdfWriter_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QPdfWriter_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QPdfWriter[] = {{25, 0, 0}, {188, 255, 1}};
