...
static sipEnumMemberDef enummembers_QPageSize[] = {
    {sipName_A0, static_cast<int>( ::QPageSize::A0), 185},
    {sipName_A1, static_cast<int>( ::QPageSize::A1), 185},
    {sipName_A10, static_cast<int>( ::QPageSize::A10), 185},
    {sipName_A2, static_cast<int>( ::QPageSize::A2), 185},
    {sipName_A3, static_cast<int>( ::QPageSize::A3), 185},
    {sipName_A3Extra, static_cast<int>( ::QPageSize::A3Extra), 185},
    {sipName_A4, static_cast<int>( ::QPageSize::A4), 185},
    {sipName_A4Extra, static_cast<int>( ::QPageSize::A4Extra), 185},
    {sipName_A4Plus, static_cast<int>( ::QPageSize::A4Plus), 185},
    {sipName_A4Small, static_cast<int>( ::QPageSize::A4Small), 185},
    {sipName_A5, static_cast<int>( ::QPageSize::A5), 185},
    {sipName_A5Extra, static_cast<int>( ::QPageSize::A5Extra), 185},
    {sipName_A6, static_cast<int>( ::QPageSize::A6), 185},
    {sipName_A7, static_cast<int>( ::QPageSize::A7), 185},
    {sipName_A8, static_cast<int>( ::QPageSize::A8), 185},
    {sipName_A9, static_cast<int>( ::QPageSize::A9), 185},
    {sipName_AnsiA, static_cast<int>( ::QPageSize::AnsiA), 185},
    {sipName_AnsiB, static_cast<int>( ::QPageSize::AnsiB), 185},
    {sipName_AnsiC, static_cast<int>( ::QPageSize::AnsiC), 185},
    {sipName_AnsiD, static_cast<int>( ::QPageSize::AnsiD), 185},
    {sipName_AnsiE, static_cast<int>( ::QPageSize::AnsiE), 185},
    {sipName_ArchA, static_cast<int>( ::QPageSize::ArchA), 185},
    {sipName_ArchB, static_cast<int>( ::QPageSize::ArchB), 185},
    {sipName_ArchC, static_cast<int>( ::QPageSize::ArchC), 185},
    {sipName_ArchD, static_cast<int>( ::QPageSize::ArchD), 185},
    {sipName_ArchE, static_cast<int>( ::QPageSize::ArchE), 185},
    {sipName_B0, static_cast<int>( ::QPageSize::B0), 185},
    {sipName_B1, static_cast<int>( ::QPageSize::B1), 185},
    {sipName_B10, static_cast<int>( ::QPageSize::B10), 185},
    {sipName_B2, static_cast<int>( ::QPageSize::B2), 185},
    {sipName_B3, static_cast<int>( ::QPageSize::B3), 185},
    {sipName_B4, static_cast<int>( ::QPageSize::B4), 185},
    {sipName_B5, static_cast<int>( ::QPageSize::B5), 185},
    {sipName_B5Extra, static_cast<int>( ::QPageSize::B5Extra), 185},
    {sipName_B6, static_cast<int>( ::QPageSize::B6), 185},
    {sipName_B7, static_cast<int>( ::QPageSize::B7), 185},
    {sipName_B8, static_cast<int>( ::QPageSize::B8), 185},
    {sipName_B9, static_cast<int>( ::QPageSize::B9), 185},
    {sipName_C5E, static_cast<int>( ::QPageSize::C5E), 185},
    {sipName_Cicero, static_cast<int>( ::QPageSize::Cicero), 187},
    {sipName_Comm10E, static_cast<int>( ::QPageSize::Comm10E), 185},
    {sipName_Custom, static_cast<int>( ::QPageSize::Custom), 185},
    {sipName_DLE, static_cast<int>( ::QPageSize::DLE), 185},
    {sipName_Didot, static_cast<int>( ::QPageSize::Didot), 187},
    {sipName_DoublePostcard, static_cast<int>( ::QPageSize::DoublePostcard), 185},
    {sipName_Envelope10, static_cast<int>( ::QPageSize::Envelope10), 185},
    {sipName_Envelope11, static_cast<int>( ::QPageSize::Envelope11), 185},
    {sipName_Envelope12, static_cast<int>( ::QPageSize::Envelope12), 185},
    {sipName_Envelope14, static_cast<int>( ::QPageSize::Envelope14), 185},
    {sipName_Envelope9, static_cast<int>( ::QPageSize::Envelope9), 185},
    {sipName_EnvelopeB4, static_cast<int>( ::QPageSize::EnvelopeB4), 185},
    {sipName_EnvelopeB5, static_cast<int>( ::QPageSize::EnvelopeB5), 185},
    {sipName_EnvelopeB6, static_cast<int>( ::QPageSize::EnvelopeB6), 185},
    {sipName_EnvelopeC0, static_cast<int>( ::QPageSize::EnvelopeC0), 185},
    {sipName_EnvelopeC1, static_cast<int>( ::QPageSize::EnvelopeC1), 185},
    {sipName_EnvelopeC2, static_cast<int>( ::QPageSize::EnvelopeC2), 185},
    {sipName_EnvelopeC3, static_cast<int>( ::QPageSize::EnvelopeC3), 185},
    {sipName_EnvelopeC4, static_cast<int>( ::QPageSize::EnvelopeC4), 185},
    {sipName_EnvelopeC5, static_cast<int>( ::QPageSize::EnvelopeC5), 185},
    {sipName_EnvelopeC6, static_cast<int>( ::QPageSize::EnvelopeC6), 185},
    {sipName_EnvelopeC65, static_cast<int>( ::QPageSize::EnvelopeC65), 185},
    {sipName_EnvelopeC7, static_cast<int>( ::QPageSize::EnvelopeC7), 185},
    {sipName_EnvelopeChou3, static_cast<int>( ::QPageSize::EnvelopeChou3), 185},
    {sipName_EnvelopeChou4, static_cast<int>( ::QPageSize::EnvelopeChou4), 185},
    {sipName_EnvelopeDL, static_cast<int>( ::QPageSize::EnvelopeDL), 185},
    {sipName_EnvelopeInvite, static_cast<int>( ::QPageSize::EnvelopeInvite), 185},
    {sipName_EnvelopeItalian, static_cast<int>( ::QPageSize::EnvelopeItalian), 185},
    {sipName_EnvelopeKaku2, static_cast<int>( ::QPageSize::EnvelopeKaku2), 185},
    {sipName_EnvelopeKaku3, static_cast<int>( ::QPageSize::EnvelopeKaku3), 185},
    {sipName_EnvelopeMonarch, static_cast<int>( ::QPageSize::EnvelopeMonarch), 185},
    {sipName_EnvelopePersonal, static_cast<int>( ::QPageSize::EnvelopePersonal), 185},
    {sipName_EnvelopePrc1, static_cast<int>( ::QPageSize::EnvelopePrc1), 185},
    {sipName_EnvelopePrc10, static_cast<int>( ::QPageSize::EnvelopePrc10), 185},
    {sipName_EnvelopePrc2, static_cast<int>( ::QPageSize::EnvelopePrc2), 185},
    {sipName_EnvelopePrc3, static_cast<int>( ::QPageSize::EnvelopePrc3), 185},
    {sipName_EnvelopePrc4, static_cast<int>( ::QPageSize::EnvelopePrc4), 185},
    {sipName_EnvelopePrc5, static_cast<int>( ::QPageSize::EnvelopePrc5), 185},
    {sipName_EnvelopePrc6, static_cast<int>( ::QPageSize::EnvelopePrc6), 185},
    {sipName_EnvelopePrc7, static_cast<int>( ::QPageSize::EnvelopePrc7), 185},
    {sipName_EnvelopePrc8, static_cast<int>( ::QPageSize::EnvelopePrc8), 185},
    {sipName_EnvelopePrc9, static_cast<int>( ::QPageSize::EnvelopePrc9), 185},
    {sipName_EnvelopeYou4, static_cast<int>( ::QPageSize::EnvelopeYou4), 185},
    {sipName_ExactMatch, static_cast<int>( ::QPageSize::ExactMatch), 186},
    {sipName_Executive, static_cast<int>( ::QPageSize::Executive), 185},
    {sipName_ExecutiveStandard, static_cast<int>( ::QPageSize::ExecutiveStandard), 185},
    {sipName_FanFoldGerman, static_cast<int>( ::QPageSize::FanFoldGerman), 185},
    {sipName_FanFoldGermanLegal, static_cast<int>( ::QPageSize::FanFoldGermanLegal), 185},
    {sipName_FanFoldUS, static_cast<int>( ::QPageSize::FanFoldUS), 185},
    {sipName_Folio, static_cast<int>( ::QPageSize::Folio), 185},
    {sipName_FuzzyMatch, static_cast<int>( ::QPageSize::FuzzyMatch), 186},
    {sipName_FuzzyOrientationMatch, static_cast<int>( ::QPageSize::FuzzyOrientationMatch), 186},
    {sipName_Imperial10x11, static_cast<int>( ::QPageSize::Imperial10x11), 185},
    {sipName_Imperial10x13, static_cast<int>( ::QPageSize::Imperial10x13), 185},
    {sipName_Imperial10x14, static_cast<int>( ::QPageSize::Imperial10x14), 185},
    {sipName_Imperial12x11, static_cast<int>( ::QPageSize::Imperial12x11), 185},
    {sipName_Imperial15x11, static_cast<int>( ::QPageSize::Imperial15x11), 185},
    {sipName_Imperial7x9, static_cast<int>( ::QPageSize::Imperial7x9), 185},
    {sipName_Imperial8x10, static_cast<int>( ::QPageSize::Imperial8x10), 185},
    {sipName_Imperial9x11, static_cast<int>( ::QPageSize::Imperial9x11), 185},
    {sipName_Imperial9x12, static_cast<int>( ::QPageSize::Imperial9x12), 185},
    {sipName_Inch, static_cast<int>( ::QPageSize::Inch), 187},
    {sipName_JisB0, static_cast<int>( ::QPageSize::JisB0), 185},
    {sipName_JisB1, static_cast<int>( ::QPageSize::JisB1), 185},
    {sipName_JisB10, static_cast<int>( ::QPageSize::JisB10), 185},
    {sipName_JisB2, static_cast<int>( ::QPageSize::JisB2), 185},
    {sipName_JisB3, static_cast<int>( ::QPageSize::JisB3), 185},
    {sipName_JisB4, static_cast<int>( ::QPageSize::JisB4), 185},
    {sipName_JisB5, static_cast<int>( ::QPageSize::JisB5), 185},
    {sipName_JisB6, static_cast<int>( ::QPageSize::JisB6), 185},
    {sipName_JisB7, static_cast<int>( ::QPageSize::JisB7), 185},
    {sipName_JisB8, static_cast<int>( ::QPageSize::JisB8), 185},
    {sipName_JisB9, static_cast<int>( ::QPageSize::JisB9), 185},
    {sipName_LastPageSize, static_cast<int>( ::QPageSize::LastPageSize), 185},
    {sipName_Ledger, static_cast<int>( ::QPageSize::Ledger), 185},
    {sipName_Legal, static_cast<int>( ::QPageSize::Legal), 185},
    {sipName_LegalExtra, static_cast<int>( ::QPageSize::LegalExtra), 185},
    {sipName_Letter, static_cast<int>( ::QPageSize::Letter), 185},
    {sipName_LetterExtra, static_cast<int>( ::QPageSize::LetterExtra), 185},
    {sipName_LetterPlus, static_cast<int>( ::QPageSize::LetterPlus), 185},
    {sipName_LetterSmall, static_cast<int>( ::QPageSize::LetterSmall), 185},
    {sipName_Millimeter, static_cast<int>( ::QPageSize::Millimeter), 187},
    {sipName_NPageSize, static_cast<int>( ::QPageSize::NPageSize), 185},
    {sipName_NPaperSize, static_cast<int>( ::QPageSize::NPaperSize), 185},
    {sipName_Note, static_cast<int>( ::QPageSize::Note), 185},
    {sipName_Pica, static_cast<int>( ::QPageSize::Pica), 187},
    {sipName_Point, static_cast<int>( ::QPageSize::Point), 187},
    {sipName_Postcard, static_cast<int>( ::QPageSize::Postcard), 185},
    {sipName_Prc16K, static_cast<int>( ::QPageSize::Prc16K), 185},
    {sipName_Prc32K, static_cast<int>( ::QPageSize::Prc32K), 185},
    {sipName_Prc32KBig, static_cast<int>( ::QPageSize::Prc32KBig), 185},
    {sipName_Quarto, static_cast<int>( ::QPageSize::Quarto), 185},
    {sipName_Statement, static_cast<int>( ::QPageSize::Statement), 185},
    {sipName_SuperA, static_cast<int>( ::QPageSize::SuperA), 185},
    {sipName_SuperB, static_cast<int>( ::QPageSize::SuperB), 185},
    {sipName_Tabloid, static_cast<int>( ::QPageSize::Tabloid), 185},
    {sipName_TabloidExtra, static_cast<int>( ::QPageSize::TabloidExtra), 185},
};
