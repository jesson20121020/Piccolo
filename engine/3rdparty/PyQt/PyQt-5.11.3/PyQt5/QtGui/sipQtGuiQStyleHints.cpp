...
static const pyqt5QtSignal signals_QStyleHints[] = {
    {"wheelScrollLinesChanged(int)", "\1wheelScrollLinesChanged(self, int)", 0, 0},
    {"useHoverEffectsChanged(bool)", "\1useHoverEffectsChanged(self, bool)", 0, 0},
