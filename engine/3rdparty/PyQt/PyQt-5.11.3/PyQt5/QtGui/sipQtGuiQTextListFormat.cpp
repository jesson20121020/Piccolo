...
static sipEncodedTypeDef supers_QTextListFormat[] = {{305, 255, 1}};
...
static sipEnumMemberDef enummembers_QTextListFormat[] = {
    {sipName_ListCircle, static_cast<int>( ::QTextListFormat::ListCircle), 332},
    {sipName_ListDecimal, static_cast<int>( ::QTextListFormat::ListDecimal), 332},
    {sipName_ListDisc, static_cast<int>( ::QTextListFormat::ListDisc), 332},
    {sipName_ListLowerAlpha, static_cast<int>( ::QTextListFormat::ListLowerAlpha), 332},
    {sipName_ListLowerRoman, static_cast<int>( ::QTextListFormat::ListLowerRoman), 332},
    {sipName_ListSquare, static_cast<int>( ::QTextListFormat::ListSquare), 332},
    {sipName_ListUpperAlpha, static_cast<int>( ::QTextListFormat::ListUpperAlpha), 332},
    {sipName_ListUpperRoman, static_cast<int>( ::QTextListFormat::ListUpperRoman), 332},
};
