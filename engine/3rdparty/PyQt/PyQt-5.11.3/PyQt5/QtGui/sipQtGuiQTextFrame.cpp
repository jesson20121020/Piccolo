...
PyDoc_STRVAR(doc_QTextFrame_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTextFrame_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTextFrame_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QTextFrame_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTextFrame_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTextFrame_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTextFrame_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTextFrame_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTextFrame_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QTextFrame_setFormat, "setFormat(self, QTextFormat)");
...
static sipEncodedTypeDef supers_QTextFrame[] = {{333, 255, 1}};
