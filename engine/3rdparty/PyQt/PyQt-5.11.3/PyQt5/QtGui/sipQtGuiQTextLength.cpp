...
static sipEnumMemberDef enummembers_QTextLength[] = {
    {sipName_FixedLength, static_cast<int>( ::QTextLength::FixedLength), 326},
    {sipName_PercentageLength, static_cast<int>( ::QTextLength::PercentageLength), 326},
    {sipName_VariableLength, static_cast<int>( ::QTextLength::VariableLength), 326},
};
