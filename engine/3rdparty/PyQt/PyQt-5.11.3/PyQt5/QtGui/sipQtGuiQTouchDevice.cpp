...
static sipEnumMemberDef enummembers_QTouchDevice[] = {
    {sipName_Area, static_cast<int>( ::QTouchDevice::Area), 347},
    {sipName_MouseEmulation, static_cast<int>( ::QTouchDevice::MouseEmulation), 347},
    {sipName_NormalizedPosition, static_cast<int>( ::QTouchDevice::NormalizedPosition), 347},
    {sipName_Position, static_cast<int>( ::QTouchDevice::Position), 347},
    {sipName_Pressure, static_cast<int>( ::QTouchDevice::Pressure), 347},
    {sipName_RawPositions, static_cast<int>( ::QTouchDevice::RawPositions), 347},
    {sipName_TouchPad, static_cast<int>( ::QTouchDevice::TouchPad), 348},
    {sipName_TouchScreen, static_cast<int>( ::QTouchDevice::TouchScreen), 348},
    {sipName_Velocity, static_cast<int>( ::QTouchDevice::Velocity), 347},
};
