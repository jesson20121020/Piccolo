...
static sipEncodedTypeDef supers_QTextFrameFormat[] = {{305, 255, 1}};
...
static sipEnumMemberDef enummembers_QTextFrameFormat[] = {
    {sipName_BorderStyle_Dashed, static_cast<int>( ::QTextFrameFormat::BorderStyle_Dashed), 315},
    {sipName_BorderStyle_DotDash, static_cast<int>( ::QTextFrameFormat::BorderStyle_DotDash), 315},
    {sipName_BorderStyle_DotDotDash, static_cast<int>( ::QTextFrameFormat::BorderStyle_DotDotDash), 315},
    {sipName_BorderStyle_Dotted, static_cast<int>( ::QTextFrameFormat::BorderStyle_Dotted), 315},
    {sipName_BorderStyle_Double, static_cast<int>( ::QTextFrameFormat::BorderStyle_Double), 315},
    {sipName_BorderStyle_Groove, static_cast<int>( ::QTextFrameFormat::BorderStyle_Groove), 315},
    {sipName_BorderStyle_Inset, static_cast<int>( ::QTextFrameFormat::BorderStyle_Inset), 315},
    {sipName_BorderStyle_None, static_cast<int>( ::QTextFrameFormat::BorderStyle_None), 315},
    {sipName_BorderStyle_Outset, static_cast<int>( ::QTextFrameFormat::BorderStyle_Outset), 315},
    {sipName_BorderStyle_Ridge, static_cast<int>( ::QTextFrameFormat::BorderStyle_Ridge), 315},
    {sipName_BorderStyle_Solid, static_cast<int>( ::QTextFrameFormat::BorderStyle_Solid), 315},
    {sipName_FloatLeft, static_cast<int>( ::QTextFrameFormat::FloatLeft), 316},
    {sipName_FloatRight, static_cast<int>( ::QTextFrameFormat::FloatRight), 316},
    {sipName_InFlow, static_cast<int>( ::QTextFrameFormat::InFlow), 316},
};
