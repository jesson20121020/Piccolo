...
static sipEnumMemberDef enummembers_QPageLayout[] = {
    {sipName_Cicero, static_cast<int>( ::QPageLayout::Cicero), 183},
    {sipName_Didot, static_cast<int>( ::QPageLayout::Didot), 183},
    {sipName_FullPageMode, static_cast<int>( ::QPageLayout::FullPageMode), 181},
    {sipName_Inch, static_cast<int>( ::QPageLayout::Inch), 183},
    {sipName_Landscape, static_cast<int>( ::QPageLayout::Landscape), 182},
    {sipName_Millimeter, static_cast<int>( ::QPageLayout::Millimeter), 183},
    {sipName_Pica, static_cast<int>( ::QPageLayout::Pica), 183},
    {sipName_Point, static_cast<int>( ::QPageLayout::Point), 183},
    {sipName_Portrait, static_cast<int>( ::QPageLayout::Portrait), 182},
    {sipName_StandardMode, static_cast<int>( ::QPageLayout::StandardMode), 181},
};
