...
PyDoc_STRVAR(doc_QValidator_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QValidator_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QValidator_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QValidator_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QValidator_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QValidator_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QValidator_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QValidator_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QValidator_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
