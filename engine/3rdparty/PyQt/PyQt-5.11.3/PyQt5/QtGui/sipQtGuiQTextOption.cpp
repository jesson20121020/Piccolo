...
static sipEnumMemberDef enummembers_QTextOption[] = {
    {sipName_AddSpaceForLineAndParagraphSeparators, static_cast<int>( ::QTextOption::AddSpaceForLineAndParagraphSeparators), 336},
    {sipName_CenterTab, static_cast<int>( ::QTextOption::CenterTab), 339},
    {sipName_DelimiterTab, static_cast<int>( ::QTextOption::DelimiterTab), 339},
    {sipName_IncludeTrailingSpaces, static_cast<int>( ::QTextOption::IncludeTrailingSpaces), 336},
    {sipName_LeftTab, static_cast<int>( ::QTextOption::LeftTab), 339},
    {sipName_ManualWrap, static_cast<int>( ::QTextOption::ManualWrap), 340},
    {sipName_NoWrap, static_cast<int>( ::QTextOption::NoWrap), 340},
    {sipName_RightTab, static_cast<int>( ::QTextOption::RightTab), 339},
    {sipName_ShowDocumentTerminator, static_cast<int>( ::QTextOption::ShowDocumentTerminator), 336},
    {sipName_ShowLineAndParagraphSeparators, static_cast<int>( ::QTextOption::ShowLineAndParagraphSeparators), 336},
    {sipName_ShowTabsAndSpaces, static_cast<int>( ::QTextOption::ShowTabsAndSpaces), 336},
    {sipName_SuppressColors, static_cast<int>( ::QTextOption::SuppressColors), 336},
    {sipName_WordWrap, static_cast<int>( ::QTextOption::WordWrap), 340},
    {sipName_WrapAnywhere, static_cast<int>( ::QTextOption::WrapAnywhere), 340},
    {sipName_WrapAtWordBoundaryOrAnywhere, static_cast<int>( ::QTextOption::WrapAtWordBoundaryOrAnywhere), 340},
};
