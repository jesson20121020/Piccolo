...
PyDoc_STRVAR(doc_QTextDocument_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTextDocument_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTextDocument_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QTextDocument_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTextDocument_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTextDocument_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTextDocument_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTextDocument_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTextDocument_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEnumMemberDef enummembers_QTextDocument[] = {
    {sipName_DocumentTitle, static_cast<int>( ::QTextDocument::DocumentTitle), 300},
    {sipName_DocumentUrl, static_cast<int>( ::QTextDocument::DocumentUrl), 300},
    {sipName_FindBackward, static_cast<int>( ::QTextDocument::FindBackward), 298},
    {sipName_FindCaseSensitively, static_cast<int>( ::QTextDocument::FindCaseSensitively), 298},
    {sipName_FindWholeWords, static_cast<int>( ::QTextDocument::FindWholeWords), 298},
    {sipName_HtmlResource, static_cast<int>( ::QTextDocument::HtmlResource), 301},
    {sipName_ImageResource, static_cast<int>( ::QTextDocument::ImageResource), 301},
    {sipName_RedoStack, static_cast<int>( ::QTextDocument::RedoStack), 302},
    {sipName_StyleSheetResource, static_cast<int>( ::QTextDocument::StyleSheetResource), 301},
    {sipName_UndoAndRedoStacks, static_cast<int>( ::QTextDocument::UndoAndRedoStacks), 302},
    {sipName_UndoStack, static_cast<int>( ::QTextDocument::UndoStack), 302},
    {sipName_UserResource, static_cast<int>( ::QTextDocument::UserResource), 301},
};
