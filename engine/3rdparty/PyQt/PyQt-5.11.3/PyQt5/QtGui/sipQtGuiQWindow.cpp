...
PyDoc_STRVAR(doc_QWindow_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QWindow_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QWindow_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QWindow_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QWindow_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QWindow_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QWindow_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QWindow_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QWindow_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static PyObject *meth_QWindow_setFlag(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE|b", &sipSelf, sipType_QWindow, &sipCpp, sipType_Qt_WindowType, &a0, &a1))
        {
...
static sipEncodedTypeDef supers_QWindow[] = {{25, 0, 0}, {269, 255, 1}};
...
static PyMethodDef methods_QWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_setFlag), (PyCFunction)meth_QWindow_setFlag, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QWindow_setFlag)},
...
static sipEnumMemberDef enummembers_QWindow[] = {
    {sipName_AutomaticVisibility, static_cast<int>( ::QWindow::AutomaticVisibility), 379},
    {sipName_ExcludeTransients, static_cast<int>( ::QWindow::ExcludeTransients), 378},
    {sipName_FullScreen, static_cast<int>( ::QWindow::FullScreen), 379},
    {sipName_Hidden, static_cast<int>( ::QWindow::Hidden), 379},
    {sipName_IncludeTransients, static_cast<int>( ::QWindow::IncludeTransients), 378},
    {sipName_Maximized, static_cast<int>( ::QWindow::Maximized), 379},
    {sipName_Minimized, static_cast<int>( ::QWindow::Minimized), 379},
    {sipName_Windowed, static_cast<int>( ::QWindow::Windowed), 379},
};
