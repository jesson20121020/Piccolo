...
static sipEnumMemberDef enummembers_QKeySequence[] = {
    {sipName_AddTab, static_cast<int>( ::QKeySequence::AddTab), 88},
    {sipName_Back, static_cast<int>( ::QKeySequence::Back), 88},
    {sipName_Backspace, static_cast<int>( ::QKeySequence::Backspace), 88},
    {sipName_Bold, static_cast<int>( ::QKeySequence::Bold), 88},
    {sipName_Cancel, static_cast<int>( ::QKeySequence::Cancel), 88},
    {sipName_Close, static_cast<int>( ::QKeySequence::Close), 88},
    {sipName_Copy, static_cast<int>( ::QKeySequence::Copy), 88},
    {sipName_Cut, static_cast<int>( ::QKeySequence::Cut), 88},
    {sipName_Delete, static_cast<int>( ::QKeySequence::Delete), 88},
    {sipName_DeleteCompleteLine, static_cast<int>( ::QKeySequence::DeleteCompleteLine), 88},
    {sipName_DeleteEndOfLine, static_cast<int>( ::QKeySequence::DeleteEndOfLine), 88},
    {sipName_DeleteEndOfWord, static_cast<int>( ::QKeySequence::DeleteEndOfWord), 88},
    {sipName_DeleteStartOfWord, static_cast<int>( ::QKeySequence::DeleteStartOfWord), 88},
    {sipName_Deselect, static_cast<int>( ::QKeySequence::Deselect), 88},
    {sipName_ExactMatch, static_cast<int>( ::QKeySequence::ExactMatch), 87},
    {sipName_Find, static_cast<int>( ::QKeySequence::Find), 88},
    {sipName_FindNext, static_cast<int>( ::QKeySequence::FindNext), 88},
    {sipName_FindPrevious, static_cast<int>( ::QKeySequence::FindPrevious), 88},
    {sipName_Forward, static_cast<int>( ::QKeySequence::Forward), 88},
    {sipName_FullScreen, static_cast<int>( ::QKeySequence::FullScreen), 88},
    {sipName_HelpContents, static_cast<int>( ::QKeySequence::HelpContents), 88},
    {sipName_InsertLineSeparator, static_cast<int>( ::QKeySequence::InsertLineSeparator), 88},
    {sipName_InsertParagraphSeparator, static_cast<int>( ::QKeySequence::InsertParagraphSeparator), 88},
    {sipName_Italic, static_cast<int>( ::QKeySequence::Italic), 88},
    {sipName_MoveToEndOfBlock, static_cast<int>( ::QKeySequence::MoveToEndOfBlock), 88},
    {sipName_MoveToEndOfDocument, static_cast<int>( ::QKeySequence::MoveToEndOfDocument), 88},
    {sipName_MoveToEndOfLine, static_cast<int>( ::QKeySequence::MoveToEndOfLine), 88},
    {sipName_MoveToNextChar, static_cast<int>( ::QKeySequence::MoveToNextChar), 88},
    {sipName_MoveToNextLine, static_cast<int>( ::QKeySequence::MoveToNextLine), 88},
    {sipName_MoveToNextPage, static_cast<int>( ::QKeySequence::MoveToNextPage), 88},
    {sipName_MoveToNextWord, static_cast<int>( ::QKeySequence::MoveToNextWord), 88},
    {sipName_MoveToPreviousChar, static_cast<int>( ::QKeySequence::MoveToPreviousChar), 88},
    {sipName_MoveToPreviousLine, static_cast<int>( ::QKeySequence::MoveToPreviousLine), 88},
    {sipName_MoveToPreviousPage, static_cast<int>( ::QKeySequence::MoveToPreviousPage), 88},
    {sipName_MoveToPreviousWord, static_cast<int>( ::QKeySequence::MoveToPreviousWord), 88},
    {sipName_MoveToStartOfBlock, static_cast<int>( ::QKeySequence::MoveToStartOfBlock), 88},
    {sipName_MoveToStartOfDocument, static_cast<int>( ::QKeySequence::MoveToStartOfDocument), 88},
    {sipName_MoveToStartOfLine, static_cast<int>( ::QKeySequence::MoveToStartOfLine), 88},
    {sipName_NativeText, static_cast<int>( ::QKeySequence::NativeText), 86},
    {sipName_New, static_cast<int>( ::QKeySequence::New), 88},
    {sipName_NextChild, static_cast<int>( ::QKeySequence::NextChild), 88},
    {sipName_NoMatch, static_cast<int>( ::QKeySequence::NoMatch), 87},
    {sipName_Open, static_cast<int>( ::QKeySequence::Open), 88},
    {sipName_PartialMatch, static_cast<int>( ::QKeySequence::PartialMatch), 87},
    {sipName_Paste, static_cast<int>( ::QKeySequence::Paste), 88},
    {sipName_PortableText, static_cast<int>( ::QKeySequence::PortableText), 86},
    {sipName_Preferences, static_cast<int>( ::QKeySequence::Preferences), 88},
    {sipName_PreviousChild, static_cast<int>( ::QKeySequence::PreviousChild), 88},
    {sipName_Print, static_cast<int>( ::QKeySequence::Print), 88},
    {sipName_Quit, static_cast<int>( ::QKeySequence::Quit), 88},
    {sipName_Redo, static_cast<int>( ::QKeySequence::Redo), 88},
    {sipName_Refresh, static_cast<int>( ::QKeySequence::Refresh), 88},
    {sipName_Replace, static_cast<int>( ::QKeySequence::Replace), 88},
    {sipName_Save, static_cast<int>( ::QKeySequence::Save), 88},
    {sipName_SaveAs, static_cast<int>( ::QKeySequence::SaveAs), 88},
    {sipName_SelectAll, static_cast<int>( ::QKeySequence::SelectAll), 88},
    {sipName_SelectEndOfBlock, static_cast<int>( ::QKeySequence::SelectEndOfBlock), 88},
    {sipName_SelectEndOfDocument, static_cast<int>( ::QKeySequence::SelectEndOfDocument), 88},
    {sipName_SelectEndOfLine, static_cast<int>( ::QKeySequence::SelectEndOfLine), 88},
    {sipName_SelectNextChar, static_cast<int>( ::QKeySequence::SelectNextChar), 88},
    {sipName_SelectNextLine, static_cast<int>( ::QKeySequence::SelectNextLine), 88},
    {sipName_SelectNextPage, static_cast<int>( ::QKeySequence::SelectNextPage), 88},
    {sipName_SelectNextWord, static_cast<int>( ::QKeySequence::SelectNextWord), 88},
    {sipName_SelectPreviousChar, static_cast<int>( ::QKeySequence::SelectPreviousChar), 88},
    {sipName_SelectPreviousLine, static_cast<int>( ::QKeySequence::SelectPreviousLine), 88},
    {sipName_SelectPreviousPage, static_cast<int>( ::QKeySequence::SelectPreviousPage), 88},
    {sipName_SelectPreviousWord, static_cast<int>( ::QKeySequence::SelectPreviousWord), 88},
    {sipName_SelectStartOfBlock, static_cast<int>( ::QKeySequence::SelectStartOfBlock), 88},
    {sipName_SelectStartOfDocument, static_cast<int>( ::QKeySequence::SelectStartOfDocument), 88},
    {sipName_SelectStartOfLine, static_cast<int>( ::QKeySequence::SelectStartOfLine), 88},
    {sipName_Underline, static_cast<int>( ::QKeySequence::Underline), 88},
    {sipName_Undo, static_cast<int>( ::QKeySequence::Undo), 88},
    {sipName_UnknownKey, static_cast<int>( ::QKeySequence::UnknownKey), 88},
    {sipName_WhatsThis, static_cast<int>( ::QKeySequence::WhatsThis), 88},
    {sipName_ZoomIn, static_cast<int>( ::QKeySequence::ZoomIn), 88},
    {sipName_ZoomOut, static_cast<int>( ::QKeySequence::ZoomOut), 88},
};
