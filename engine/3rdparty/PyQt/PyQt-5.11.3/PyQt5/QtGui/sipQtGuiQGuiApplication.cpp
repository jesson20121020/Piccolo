...
PyDoc_STRVAR(doc_QGuiApplication_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QGuiApplication_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QGuiApplication_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QGuiApplication_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QGuiApplication_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGuiApplication_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGuiApplication_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGuiApplication_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QGuiApplication_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QGuiApplication_applicationDisplayNameChanged, "applicationDisplayNameChanged(self)");

extern "C" {static PyObject *meth_QGuiApplication_applicationDisplayNameChanged(PyObject *, PyObject *);}
static PyObject *meth_QGuiApplication_applicationDisplayNameChanged(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        {
            sipCpp->applicationDisplayNameChanged();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QGuiApplication, sipName_applicationDisplayNameChanged, doc_QGuiApplication_applicationDisplayNameChanged);
...
static PyMethodDef methods_QGuiApplication[] = {
    ...
    {SIP_MLNAME_CAST(sipName_applicationDisplayNameChanged), meth_QGuiApplication_applicationDisplayNameChanged, METH_VARARGS, SIP_MLDOC_CAST(doc_QGuiApplication_applicationDisplayNameChanged)},
