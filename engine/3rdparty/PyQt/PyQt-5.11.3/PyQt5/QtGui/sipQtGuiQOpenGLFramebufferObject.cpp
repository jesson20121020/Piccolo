...
static sipEnumMemberDef enummembers_QOpenGLFramebufferObject[] = {
    {sipName_CombinedDepthStencil, static_cast<int>( ::QOpenGLFramebufferObject::CombinedDepthStencil), 143},
    {sipName_Depth, static_cast<int>( ::QOpenGLFramebufferObject::Depth), 143},
    {sipName_DontRestoreFramebufferBinding, static_cast<int>( ::QOpenGLFramebufferObject::DontRestoreFramebufferBinding), 144},
    {sipName_NoAttachment, static_cast<int>( ::QOpenGLFramebufferObject::NoAttachment), 143},
    {sipName_RestoreFrameBufferBinding, static_cast<int>( ::QOpenGLFramebufferObject::RestoreFrameBufferBinding), 144},
    {sipName_RestoreFramebufferBindingToDefault, static_cast<int>( ::QOpenGLFramebufferObject::RestoreFramebufferBindingToDefault), 144},
};
