...
PyDoc_STRVAR(doc_QDoubleValidator_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QDoubleValidator_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QDoubleValidator_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QDoubleValidator_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QDoubleValidator_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QDoubleValidator_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QDoubleValidator_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QDoubleValidator_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QDoubleValidator_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QDoubleValidator[] = {{355, 255, 1}};
