...
static sipEnumMemberDef enummembers_QTransform[] = {
    {sipName_TxNone, static_cast<int>( ::QTransform::TxNone), 354},
    {sipName_TxProject, static_cast<int>( ::QTransform::TxProject), 354},
    {sipName_TxRotate, static_cast<int>( ::QTransform::TxRotate), 354},
    {sipName_TxScale, static_cast<int>( ::QTransform::TxScale), 354},
    {sipName_TxShear, static_cast<int>( ::QTransform::TxShear), 354},
    {sipName_TxTranslate, static_cast<int>( ::QTransform::TxTranslate), 354},
};
