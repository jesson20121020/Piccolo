...
static sipEnumMemberDef enummembers_QPainter[] = {
    {sipName_Antialiasing, static_cast<int>( ::QPainter::Antialiasing), 209},
    {sipName_CompositionMode_Clear, static_cast<int>( ::QPainter::CompositionMode_Clear), 205},
    {sipName_CompositionMode_ColorBurn, static_cast<int>( ::QPainter::CompositionMode_ColorBurn), 205},
    {sipName_CompositionMode_ColorDodge, static_cast<int>( ::QPainter::CompositionMode_ColorDodge), 205},
    {sipName_CompositionMode_Darken, static_cast<int>( ::QPainter::CompositionMode_Darken), 205},
    {sipName_CompositionMode_Destination, static_cast<int>( ::QPainter::CompositionMode_Destination), 205},
    {sipName_CompositionMode_DestinationAtop, static_cast<int>( ::QPainter::CompositionMode_DestinationAtop), 205},
    {sipName_CompositionMode_DestinationIn, static_cast<int>( ::QPainter::CompositionMode_DestinationIn), 205},
    {sipName_CompositionMode_DestinationOut, static_cast<int>( ::QPainter::CompositionMode_DestinationOut), 205},
    {sipName_CompositionMode_DestinationOver, static_cast<int>( ::QPainter::CompositionMode_DestinationOver), 205},
    {sipName_CompositionMode_Difference, static_cast<int>( ::QPainter::CompositionMode_Difference), 205},
    {sipName_CompositionMode_Exclusion, static_cast<int>( ::QPainter::CompositionMode_Exclusion), 205},
    {sipName_CompositionMode_HardLight, static_cast<int>( ::QPainter::CompositionMode_HardLight), 205},
    {sipName_CompositionMode_Lighten, static_cast<int>( ::QPainter::CompositionMode_Lighten), 205},
    {sipName_CompositionMode_Multiply, static_cast<int>( ::QPainter::CompositionMode_Multiply), 205},
    {sipName_CompositionMode_Overlay, static_cast<int>( ::QPainter::CompositionMode_Overlay), 205},
    {sipName_CompositionMode_Plus, static_cast<int>( ::QPainter::CompositionMode_Plus), 205},
    {sipName_CompositionMode_Screen, static_cast<int>( ::QPainter::CompositionMode_Screen), 205},
    {sipName_CompositionMode_SoftLight, static_cast<int>( ::QPainter::CompositionMode_SoftLight), 205},
    {sipName_CompositionMode_Source, static_cast<int>( ::QPainter::CompositionMode_Source), 205},
    {sipName_CompositionMode_SourceAtop, static_cast<int>( ::QPainter::CompositionMode_SourceAtop), 205},
    {sipName_CompositionMode_SourceIn, static_cast<int>( ::QPainter::CompositionMode_SourceIn), 205},
    {sipName_CompositionMode_SourceOut, static_cast<int>( ::QPainter::CompositionMode_SourceOut), 205},
    {sipName_CompositionMode_SourceOver, static_cast<int>( ::QPainter::CompositionMode_SourceOver), 205},
    {sipName_CompositionMode_Xor, static_cast<int>( ::QPainter::CompositionMode_Xor), 205},
    {sipName_HighQualityAntialiasing, static_cast<int>( ::QPainter::HighQualityAntialiasing), 209},
    {sipName_NonCosmeticDefaultPen, static_cast<int>( ::QPainter::NonCosmeticDefaultPen), 209},
    {sipName_OpaqueHint, static_cast<int>( ::QPainter::OpaqueHint), 207},
    {sipName_Qt4CompatiblePainting, static_cast<int>( ::QPainter::Qt4CompatiblePainting), 209},
    {sipName_RasterOp_ClearDestination, static_cast<int>( ::QPainter::RasterOp_ClearDestination), 205},
    {sipName_RasterOp_NotDestination, static_cast<int>( ::QPainter::RasterOp_NotDestination), 205},
    {sipName_RasterOp_NotSource, static_cast<int>( ::QPainter::RasterOp_NotSource), 205},
    {sipName_RasterOp_NotSourceAndDestination, static_cast<int>( ::QPainter::RasterOp_NotSourceAndDestination), 205},
    {sipName_RasterOp_NotSourceAndNotDestination, static_cast<int>( ::QPainter::RasterOp_NotSourceAndNotDestination), 205},
    {sipName_RasterOp_NotSourceOrDestination, static_cast<int>( ::QPainter::RasterOp_NotSourceOrDestination), 205},
    {sipName_RasterOp_NotSourceOrNotDestination, static_cast<int>( ::QPainter::RasterOp_NotSourceOrNotDestination), 205},
    {sipName_RasterOp_NotSourceXorDestination, static_cast<int>( ::QPainter::RasterOp_NotSourceXorDestination), 205},
    {sipName_RasterOp_SetDestination, static_cast<int>( ::QPainter::RasterOp_SetDestination), 205},
    {sipName_RasterOp_SourceAndDestination, static_cast<int>( ::QPainter::RasterOp_SourceAndDestination), 205},
    {sipName_RasterOp_SourceAndNotDestination, static_cast<int>( ::QPainter::RasterOp_SourceAndNotDestination), 205},
    {sipName_RasterOp_SourceOrDestination, static_cast<int>( ::QPainter::RasterOp_SourceOrDestination), 205},
    {sipName_RasterOp_SourceOrNotDestination, static_cast<int>( ::QPainter::RasterOp_SourceOrNotDestination), 205},
    {sipName_RasterOp_SourceXorDestination, static_cast<int>( ::QPainter::RasterOp_SourceXorDestination), 205},
    {sipName_SmoothPixmapTransform, static_cast<int>( ::QPainter::SmoothPixmapTransform), 209},
    {sipName_TextAntialiasing, static_cast<int>( ::QPainter::TextAntialiasing), 209},
};
