...
static sipEnumMemberDef enummembers_QImageReader[] = {
    {sipName_DeviceError, static_cast<int>( ::QImageReader::DeviceError), 73},
    {sipName_FileNotFoundError, static_cast<int>( ::QImageReader::FileNotFoundError), 73},
    {sipName_InvalidDataError, static_cast<int>( ::QImageReader::InvalidDataError), 73},
    {sipName_UnknownError, static_cast<int>( ::QImageReader::UnknownError), 73},
    {sipName_UnsupportedFormatError, static_cast<int>( ::QImageReader::UnsupportedFormatError), 73},
};
