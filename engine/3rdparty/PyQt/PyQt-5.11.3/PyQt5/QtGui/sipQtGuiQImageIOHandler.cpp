...
static sipEnumMemberDef enummembers_QImageIOHandler[] = {
    {sipName_Animation, static_cast<int>( ::QImageIOHandler::Animation), 69},
    {sipName_BackgroundColor, static_cast<int>( ::QImageIOHandler::BackgroundColor), 69},
    {sipName_ClipRect, static_cast<int>( ::QImageIOHandler::ClipRect), 69},
    {sipName_CompressionRatio, static_cast<int>( ::QImageIOHandler::CompressionRatio), 69},
    {sipName_Description, static_cast<int>( ::QImageIOHandler::Description), 69},
    {sipName_Endianness, static_cast<int>( ::QImageIOHandler::Endianness), 69},
    {sipName_Gamma, static_cast<int>( ::QImageIOHandler::Gamma), 69},
    {sipName_ImageTransformation, static_cast<int>( ::QImageIOHandler::ImageTransformation), 69},
    {sipName_IncrementalReading, static_cast<int>( ::QImageIOHandler::IncrementalReading), 69},
    {sipName_Name, static_cast<int>( ::QImageIOHandler::Name), 69},
    {sipName_OptimizedWrite, static_cast<int>( ::QImageIOHandler::OptimizedWrite), 69},
    {sipName_ProgressiveScanWrite, static_cast<int>( ::QImageIOHandler::ProgressiveScanWrite), 69},
    {sipName_Quality, static_cast<int>( ::QImageIOHandler::Quality), 69},
    {sipName_ScaledClipRect, static_cast<int>( ::QImageIOHandler::ScaledClipRect), 69},
    {sipName_ScaledSize, static_cast<int>( ::QImageIOHandler::ScaledSize), 69},
    {sipName_Size, static_cast<int>( ::QImageIOHandler::Size), 69},
    {sipName_SubType, static_cast<int>( ::QImageIOHandler::SubType), 69},
    {sipName_SupportedSubTypes, static_cast<int>( ::QImageIOHandler::SupportedSubTypes), 69},
    {sipName_TransformationFlip, static_cast<int>( ::QImageIOHandler::TransformationFlip), 70},
    {sipName_TransformationFlipAndRotate90, static_cast<int>( ::QImageIOHandler::TransformationFlipAndRotate90), 70},
    {sipName_TransformationMirror, static_cast<int>( ::QImageIOHandler::TransformationMirror), 70},
    {sipName_TransformationMirrorAndRotate90, static_cast<int>( ::QImageIOHandler::TransformationMirrorAndRotate90), 70},
    {sipName_TransformationNone, static_cast<int>( ::QImageIOHandler::TransformationNone), 70},
    {sipName_TransformationRotate180, static_cast<int>( ::QImageIOHandler::TransformationRotate180), 70},
    {sipName_TransformationRotate270, static_cast<int>( ::QImageIOHandler::TransformationRotate270), 70},
    {sipName_TransformationRotate90, static_cast<int>( ::QImageIOHandler::TransformationRotate90), 70},
    {sipName_TransformedByDefault, static_cast<int>( ::QImageIOHandler::TransformedByDefault), 69},
};
