...
static sipEnumMemberDef enummembers_QPainterPath[] = {
    {sipName_CurveToDataElement, static_cast<int>( ::QPainterPath::CurveToDataElement), 213},
    {sipName_CurveToElement, static_cast<int>( ::QPainterPath::CurveToElement), 213},
    {sipName_LineToElement, static_cast<int>( ::QPainterPath::LineToElement), 213},
    {sipName_MoveToElement, static_cast<int>( ::QPainterPath::MoveToElement), 213},
};
