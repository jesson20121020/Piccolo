...
sipQNativeGestureEvent::sipQNativeGestureEvent( ::Qt::NativeGestureType a0,const  ::QTouchDevice*a1,const  ::QPointF& a2,const  ::QPointF& a3,const  ::QPointF& a4, ::qreal a5, ::ulong a6, ::quint64 a7):  ::QNativeGestureEvent(a0,a1,a2,a3,a4,a5,a6,a7), sipPySelf(0)
{
}
...
static PyObject *meth_QNativeGestureEvent_device(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QNativeGestureEvent, &sipCpp))
        {
            ...
            return sipConvertFromType(const_cast< ::QTouchDevice *>(sipRes),sipType_QTouchDevice,NULL);
        }
    }
...
static void *init_type_QNativeGestureEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "EJ8J1J1J1dmo", sipType_Qt_NativeGestureType, &a0, sipType_QTouchDevice, &a1, sipType_QPointF, &a2, &a2State, sipType_QPointF, &a3, &a3State, sipType_QPointF, &a4, &a4State, &a5, &a6, &a7))
        {
...
static sipEncodedTypeDef supers_QNativeGestureEvent[] = {{76, 255, 1}};
