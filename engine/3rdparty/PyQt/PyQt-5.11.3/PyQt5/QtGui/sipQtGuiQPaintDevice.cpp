...
static sipEnumMemberDef enummembers_QPaintDevice[] = {
    {sipName_PdmDepth, static_cast<int>( ::QPaintDevice::PdmDepth), 193},
    {sipName_PdmDevicePixelRatio, static_cast<int>( ::QPaintDevice::PdmDevicePixelRatio), 193},
    {sipName_PdmDevicePixelRatioScaled, static_cast<int>( ::QPaintDevice::PdmDevicePixelRatioScaled), 193},
    {sipName_PdmDpiX, static_cast<int>( ::QPaintDevice::PdmDpiX), 193},
    {sipName_PdmDpiY, static_cast<int>( ::QPaintDevice::PdmDpiY), 193},
    {sipName_PdmHeight, static_cast<int>( ::QPaintDevice::PdmHeight), 193},
    {sipName_PdmHeightMM, static_cast<int>( ::QPaintDevice::PdmHeightMM), 193},
    {sipName_PdmNumColors, static_cast<int>( ::QPaintDevice::PdmNumColors), 193},
    {sipName_PdmPhysicalDpiX, static_cast<int>( ::QPaintDevice::PdmPhysicalDpiX), 193},
    {sipName_PdmPhysicalDpiY, static_cast<int>( ::QPaintDevice::PdmPhysicalDpiY), 193},
    {sipName_PdmWidth, static_cast<int>( ::QPaintDevice::PdmWidth), 193},
    {sipName_PdmWidthMM, static_cast<int>( ::QPaintDevice::PdmWidthMM), 193},
};
