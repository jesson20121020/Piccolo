...
static sipEncodedTypeDef supers_QTextBlockFormat[] = {{305, 255, 1}};
...
static sipEnumMemberDef enummembers_QTextBlockFormat[] = {
    {sipName_FixedHeight, static_cast<int>( ::QTextBlockFormat::FixedHeight), 286},
    {sipName_LineDistanceHeight, static_cast<int>( ::QTextBlockFormat::LineDistanceHeight), 286},
    {sipName_MinimumHeight, static_cast<int>( ::QTextBlockFormat::MinimumHeight), 286},
    {sipName_ProportionalHeight, static_cast<int>( ::QTextBlockFormat::ProportionalHeight), 286},
    {sipName_SingleHeight, static_cast<int>( ::QTextBlockFormat::SingleHeight), 286},
};
