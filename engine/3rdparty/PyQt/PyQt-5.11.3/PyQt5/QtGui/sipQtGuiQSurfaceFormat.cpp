...
static sipEnumMemberDef enummembers_QSurfaceFormat[] = {
    {sipName_CompatibilityProfile, static_cast<int>( ::QSurfaceFormat::CompatibilityProfile), 276},
    {sipName_CoreProfile, static_cast<int>( ::QSurfaceFormat::CoreProfile), 276},
    {sipName_DebugContext, static_cast<int>( ::QSurfaceFormat::DebugContext), 274},
    {sipName_DefaultColorSpace, static_cast<int>( ::QSurfaceFormat::DefaultColorSpace), 273},
    {sipName_DefaultRenderableType, static_cast<int>( ::QSurfaceFormat::DefaultRenderableType), 277},
    {sipName_DefaultSwapBehavior, static_cast<int>( ::QSurfaceFormat::DefaultSwapBehavior), 278},
    {sipName_DeprecatedFunctions, static_cast<int>( ::QSurfaceFormat::DeprecatedFunctions), 274},
    {sipName_DoubleBuffer, static_cast<int>( ::QSurfaceFormat::DoubleBuffer), 278},
    {sipName_NoProfile, static_cast<int>( ::QSurfaceFormat::NoProfile), 276},
    {sipName_OpenGL, static_cast<int>( ::QSurfaceFormat::OpenGL), 277},
    {sipName_OpenGLES, static_cast<int>( ::QSurfaceFormat::OpenGLES), 277},
    {sipName_OpenVG, static_cast<int>( ::QSurfaceFormat::OpenVG), 277},
    {sipName_ResetNotification, static_cast<int>( ::QSurfaceFormat::ResetNotification), 274},
    {sipName_SingleBuffer, static_cast<int>( ::QSurfaceFormat::SingleBuffer), 278},
    {sipName_StereoBuffers, static_cast<int>( ::QSurfaceFormat::StereoBuffers), 274},
    {sipName_TripleBuffer, static_cast<int>( ::QSurfaceFormat::TripleBuffer), 278},
    {sipName_sRGBColorSpace, static_cast<int>( ::QSurfaceFormat::sRGBColorSpace), 273},
};
