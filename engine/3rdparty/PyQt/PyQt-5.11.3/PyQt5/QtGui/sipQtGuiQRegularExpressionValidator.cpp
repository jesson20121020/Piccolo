...
PyDoc_STRVAR(doc_QRegularExpressionValidator_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QRegularExpressionValidator_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QRegularExpressionValidator[] = {{355, 255, 1}};
