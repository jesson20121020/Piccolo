...
static sipEnumMemberDef enummembers_QScrollEvent[] = {
    {sipName_ScrollFinished, static_cast<int>( ::QScrollEvent::ScrollFinished), 255},
    {sipName_ScrollStarted, static_cast<int>( ::QScrollEvent::ScrollStarted), 255},
    {sipName_ScrollUpdated, static_cast<int>( ::QScrollEvent::ScrollUpdated), 255},
};
