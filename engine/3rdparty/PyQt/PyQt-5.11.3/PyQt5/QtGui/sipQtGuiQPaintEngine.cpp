...
static sipEnumMemberDef enummembers_QPaintEngine[] = {
    {sipName_AllDirty, static_cast<int>( ::QPaintEngine::AllDirty), 196},
    {sipName_AllFeatures, static_cast<int>( ::QPaintEngine::AllFeatures), 198},
    {sipName_AlphaBlend, static_cast<int>( ::QPaintEngine::AlphaBlend), 198},
    {sipName_Antialiasing, static_cast<int>( ::QPaintEngine::Antialiasing), 198},
    {sipName_BlendModes, static_cast<int>( ::QPaintEngine::BlendModes), 198},
    {sipName_Blitter, static_cast<int>( ::QPaintEngine::Blitter), 201},
    {sipName_BrushStroke, static_cast<int>( ::QPaintEngine::BrushStroke), 198},
    {sipName_ConicalGradientFill, static_cast<int>( ::QPaintEngine::ConicalGradientFill), 198},
    {sipName_ConstantOpacity, static_cast<int>( ::QPaintEngine::ConstantOpacity), 198},
    {sipName_ConvexMode, static_cast<int>( ::QPaintEngine::ConvexMode), 200},
    {sipName_CoreGraphics, static_cast<int>( ::QPaintEngine::CoreGraphics), 201},
    {sipName_Direct2D, static_cast<int>( ::QPaintEngine::Direct2D), 201},
    {sipName_Direct3D, static_cast<int>( ::QPaintEngine::Direct3D), 201},
    {sipName_DirtyBackground, static_cast<int>( ::QPaintEngine::DirtyBackground), 196},
    {sipName_DirtyBackgroundMode, static_cast<int>( ::QPaintEngine::DirtyBackgroundMode), 196},
    {sipName_DirtyBrush, static_cast<int>( ::QPaintEngine::DirtyBrush), 196},
    {sipName_DirtyBrushOrigin, static_cast<int>( ::QPaintEngine::DirtyBrushOrigin), 196},
    {sipName_DirtyClipEnabled, static_cast<int>( ::QPaintEngine::DirtyClipEnabled), 196},
    {sipName_DirtyClipPath, static_cast<int>( ::QPaintEngine::DirtyClipPath), 196},
    {sipName_DirtyClipRegion, static_cast<int>( ::QPaintEngine::DirtyClipRegion), 196},
    {sipName_DirtyCompositionMode, static_cast<int>( ::QPaintEngine::DirtyCompositionMode), 196},
    {sipName_DirtyFont, static_cast<int>( ::QPaintEngine::DirtyFont), 196},
    {sipName_DirtyHints, static_cast<int>( ::QPaintEngine::DirtyHints), 196},
    {sipName_DirtyOpacity, static_cast<int>( ::QPaintEngine::DirtyOpacity), 196},
    {sipName_DirtyPen, static_cast<int>( ::QPaintEngine::DirtyPen), 196},
    {sipName_DirtyTransform, static_cast<int>( ::QPaintEngine::DirtyTransform), 196},
    {sipName_LinearGradientFill, static_cast<int>( ::QPaintEngine::LinearGradientFill), 198},
    {sipName_MacPrinter, static_cast<int>( ::QPaintEngine::MacPrinter), 201},
    {sipName_MaskedBrush, static_cast<int>( ::QPaintEngine::MaskedBrush), 198},
    {sipName_MaxUser, static_cast<int>( ::QPaintEngine::MaxUser), 201},
    {sipName_ObjectBoundingModeGradients, static_cast<int>( ::QPaintEngine::ObjectBoundingModeGradients), 198},
    {sipName_OddEvenMode, static_cast<int>( ::QPaintEngine::OddEvenMode), 200},
    {sipName_OpenGL, static_cast<int>( ::QPaintEngine::OpenGL), 201},
    {sipName_OpenGL2, static_cast<int>( ::QPaintEngine::OpenGL2), 201},
    {sipName_OpenVG, static_cast<int>( ::QPaintEngine::OpenVG), 201},
    {sipName_PaintBuffer, static_cast<int>( ::QPaintEngine::PaintBuffer), 201},
    {sipName_PaintOutsidePaintEvent, static_cast<int>( ::QPaintEngine::PaintOutsidePaintEvent), 198},
    {sipName_PainterPaths, static_cast<int>( ::QPaintEngine::PainterPaths), 198},
    {sipName_PatternBrush, static_cast<int>( ::QPaintEngine::PatternBrush), 198},
    {sipName_PatternTransform, static_cast<int>( ::QPaintEngine::PatternTransform), 198},
    {sipName_Pdf, static_cast<int>( ::QPaintEngine::Pdf), 201},
    {sipName_PerspectiveTransform, static_cast<int>( ::QPaintEngine::PerspectiveTransform), 198},
    {sipName_Picture, static_cast<int>( ::QPaintEngine::Picture), 201},
    {sipName_PixmapTransform, static_cast<int>( ::QPaintEngine::PixmapTransform), 198},
    {sipName_PolylineMode, static_cast<int>( ::QPaintEngine::PolylineMode), 200},
    {sipName_PorterDuff, static_cast<int>( ::QPaintEngine::PorterDuff), 198},
    {sipName_PostScript, static_cast<int>( ::QPaintEngine::PostScript), 201},
    {sipName_PrimitiveTransform, static_cast<int>( ::QPaintEngine::PrimitiveTransform), 198},
    {sipName_QWindowSystem, static_cast<int>( ::QPaintEngine::QWindowSystem), 201},
    {sipName_QuickDraw, static_cast<int>( ::QPaintEngine::QuickDraw), 201},
    {sipName_RadialGradientFill, static_cast<int>( ::QPaintEngine::RadialGradientFill), 198},
    {sipName_Raster, static_cast<int>( ::QPaintEngine::Raster), 201},
    {sipName_RasterOpModes, static_cast<int>( ::QPaintEngine::RasterOpModes), 198},
    {sipName_SVG, static_cast<int>( ::QPaintEngine::SVG), 201},
    {sipName_User, static_cast<int>( ::QPaintEngine::User), 201},
    {sipName_WindingMode, static_cast<int>( ::QPaintEngine::WindingMode), 200},
    {sipName_Windows, static_cast<int>( ::QPaintEngine::Windows), 201},
    {sipName_X11, static_cast<int>( ::QPaintEngine::X11), 201},
};
