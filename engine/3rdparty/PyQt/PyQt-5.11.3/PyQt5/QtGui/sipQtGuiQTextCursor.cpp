...
static sipEnumMemberDef enummembers_QTextCursor[] = {
    {sipName_BlockUnderCursor, static_cast<int>( ::QTextCursor::BlockUnderCursor), 296},
    {sipName_Document, static_cast<int>( ::QTextCursor::Document), 296},
    {sipName_Down, static_cast<int>( ::QTextCursor::Down), 295},
    {sipName_End, static_cast<int>( ::QTextCursor::End), 295},
    {sipName_EndOfBlock, static_cast<int>( ::QTextCursor::EndOfBlock), 295},
    {sipName_EndOfLine, static_cast<int>( ::QTextCursor::EndOfLine), 295},
    {sipName_EndOfWord, static_cast<int>( ::QTextCursor::EndOfWord), 295},
    {sipName_KeepAnchor, static_cast<int>( ::QTextCursor::KeepAnchor), 294},
    {sipName_Left, static_cast<int>( ::QTextCursor::Left), 295},
    {sipName_LineUnderCursor, static_cast<int>( ::QTextCursor::LineUnderCursor), 296},
    {sipName_MoveAnchor, static_cast<int>( ::QTextCursor::MoveAnchor), 294},
    {sipName_NextBlock, static_cast<int>( ::QTextCursor::NextBlock), 295},
    {sipName_NextCell, static_cast<int>( ::QTextCursor::NextCell), 295},
    {sipName_NextCharacter, static_cast<int>( ::QTextCursor::NextCharacter), 295},
    {sipName_NextRow, static_cast<int>( ::QTextCursor::NextRow), 295},
    {sipName_NextWord, static_cast<int>( ::QTextCursor::NextWord), 295},
    {sipName_NoMove, static_cast<int>( ::QTextCursor::NoMove), 295},
    {sipName_PreviousBlock, static_cast<int>( ::QTextCursor::PreviousBlock), 295},
    {sipName_PreviousCell, static_cast<int>( ::QTextCursor::PreviousCell), 295},
    {sipName_PreviousCharacter, static_cast<int>( ::QTextCursor::PreviousCharacter), 295},
    {sipName_PreviousRow, static_cast<int>( ::QTextCursor::PreviousRow), 295},
    {sipName_PreviousWord, static_cast<int>( ::QTextCursor::PreviousWord), 295},
    {sipName_Right, static_cast<int>( ::QTextCursor::Right), 295},
    {sipName_Start, static_cast<int>( ::QTextCursor::Start), 295},
    {sipName_StartOfBlock, static_cast<int>( ::QTextCursor::StartOfBlock), 295},
    {sipName_StartOfLine, static_cast<int>( ::QTextCursor::StartOfLine), 295},
    {sipName_StartOfWord, static_cast<int>( ::QTextCursor::StartOfWord), 295},
    {sipName_Up, static_cast<int>( ::QTextCursor::Up), 295},
    {sipName_WordLeft, static_cast<int>( ::QTextCursor::WordLeft), 295},
    {sipName_WordRight, static_cast<int>( ::QTextCursor::WordRight), 295},
    {sipName_WordUnderCursor, static_cast<int>( ::QTextCursor::WordUnderCursor), 296},
};
