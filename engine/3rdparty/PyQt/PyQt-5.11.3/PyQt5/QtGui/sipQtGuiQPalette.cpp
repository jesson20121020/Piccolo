...
static sipEnumMemberDef enummembers_QPalette[] = {
    {sipName_Active, static_cast<int>( ::QPalette::Active), 218},
    {sipName_All, static_cast<int>( ::QPalette::All), 218},
    {sipName_AlternateBase, static_cast<int>( ::QPalette::AlternateBase), 219},
    {sipName_Background, static_cast<int>( ::QPalette::Background), 219},
    {sipName_Base, static_cast<int>( ::QPalette::Base), 219},
    {sipName_BrightText, static_cast<int>( ::QPalette::BrightText), 219},
    {sipName_Button, static_cast<int>( ::QPalette::Button), 219},
    {sipName_ButtonText, static_cast<int>( ::QPalette::ButtonText), 219},
    {sipName_Current, static_cast<int>( ::QPalette::Current), 218},
    {sipName_Dark, static_cast<int>( ::QPalette::Dark), 219},
    {sipName_Disabled, static_cast<int>( ::QPalette::Disabled), 218},
    {sipName_Foreground, static_cast<int>( ::QPalette::Foreground), 219},
    {sipName_Highlight, static_cast<int>( ::QPalette::Highlight), 219},
    {sipName_HighlightedText, static_cast<int>( ::QPalette::HighlightedText), 219},
    {sipName_Inactive, static_cast<int>( ::QPalette::Inactive), 218},
    {sipName_Light, static_cast<int>( ::QPalette::Light), 219},
    {sipName_Link, static_cast<int>( ::QPalette::Link), 219},
    {sipName_LinkVisited, static_cast<int>( ::QPalette::LinkVisited), 219},
    {sipName_Mid, static_cast<int>( ::QPalette::Mid), 219},
    {sipName_Midlight, static_cast<int>( ::QPalette::Midlight), 219},
    {sipName_NColorGroups, static_cast<int>( ::QPalette::NColorGroups), 218},
    {sipName_NColorRoles, static_cast<int>( ::QPalette::NColorRoles), 219},
    {sipName_NoRole, static_cast<int>( ::QPalette::NoRole), 219},
    {sipName_Normal, static_cast<int>( ::QPalette::Normal), 218},
    {sipName_Shadow, static_cast<int>( ::QPalette::Shadow), 219},
    {sipName_Text, static_cast<int>( ::QPalette::Text), 219},
    {sipName_ToolTipBase, static_cast<int>( ::QPalette::ToolTipBase), 219},
    {sipName_ToolTipText, static_cast<int>( ::QPalette::ToolTipText), 219},
    {sipName_Window, static_cast<int>( ::QPalette::Window), 219},
    {sipName_WindowText, static_cast<int>( ::QPalette::WindowText), 219},
};
