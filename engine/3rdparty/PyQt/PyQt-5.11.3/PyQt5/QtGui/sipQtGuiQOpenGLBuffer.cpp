...
static sipEnumMemberDef enummembers_QOpenGLBuffer[] = {
    {sipName_DynamicCopy, static_cast<int>( ::QOpenGLBuffer::DynamicCopy), 129},
    {sipName_DynamicDraw, static_cast<int>( ::QOpenGLBuffer::DynamicDraw), 129},
    {sipName_DynamicRead, static_cast<int>( ::QOpenGLBuffer::DynamicRead), 129},
    {sipName_IndexBuffer, static_cast<int>( ::QOpenGLBuffer::IndexBuffer), 128},
    {sipName_PixelPackBuffer, static_cast<int>( ::QOpenGLBuffer::PixelPackBuffer), 128},
    {sipName_PixelUnpackBuffer, static_cast<int>( ::QOpenGLBuffer::PixelUnpackBuffer), 128},
    {sipName_RangeFlushExplicit, static_cast<int>( ::QOpenGLBuffer::RangeFlushExplicit), 126},
    {sipName_RangeInvalidate, static_cast<int>( ::QOpenGLBuffer::RangeInvalidate), 126},
    {sipName_RangeInvalidateBuffer, static_cast<int>( ::QOpenGLBuffer::RangeInvalidateBuffer), 126},
    {sipName_RangeRead, static_cast<int>( ::QOpenGLBuffer::RangeRead), 126},
    {sipName_RangeUnsynchronized, static_cast<int>( ::QOpenGLBuffer::RangeUnsynchronized), 126},
    {sipName_RangeWrite, static_cast<int>( ::QOpenGLBuffer::RangeWrite), 126},
    {sipName_ReadOnly, static_cast<int>( ::QOpenGLBuffer::ReadOnly), 125},
    {sipName_ReadWrite, static_cast<int>( ::QOpenGLBuffer::ReadWrite), 125},
    {sipName_StaticCopy, static_cast<int>( ::QOpenGLBuffer::StaticCopy), 129},
    {sipName_StaticDraw, static_cast<int>( ::QOpenGLBuffer::StaticDraw), 129},
    {sipName_StaticRead, static_cast<int>( ::QOpenGLBuffer::StaticRead), 129},
    {sipName_StreamCopy, static_cast<int>( ::QOpenGLBuffer::StreamCopy), 129},
    {sipName_StreamDraw, static_cast<int>( ::QOpenGLBuffer::StreamDraw), 129},
    {sipName_StreamRead, static_cast<int>( ::QOpenGLBuffer::StreamRead), 129},
    {sipName_VertexBuffer, static_cast<int>( ::QOpenGLBuffer::VertexBuffer), 128},
    {sipName_WriteOnly, static_cast<int>( ::QOpenGLBuffer::WriteOnly), 125},
};
