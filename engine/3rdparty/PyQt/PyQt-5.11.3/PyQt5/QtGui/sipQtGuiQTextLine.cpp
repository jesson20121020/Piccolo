...
static sipEnumMemberDef enummembers_QTextLine[] = {
    {sipName_CursorBetweenCharacters, static_cast<int>( ::QTextLine::CursorBetweenCharacters), 328},
    {sipName_CursorOnCharacter, static_cast<int>( ::QTextLine::CursorOnCharacter), 328},
    {sipName_Leading, static_cast<int>( ::QTextLine::Leading), 329},
    {sipName_Trailing, static_cast<int>( ::QTextLine::Trailing), 329},
};
