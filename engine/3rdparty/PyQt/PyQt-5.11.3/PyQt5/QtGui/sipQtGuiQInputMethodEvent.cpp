...
static sipEnumMemberDef enummembers_QInputMethodEvent[] = {
    {sipName_Cursor, static_cast<int>( ::QInputMethodEvent::Cursor), 81},
    {sipName_Language, static_cast<int>( ::QInputMethodEvent::Language), 81},
    {sipName_Ruby, static_cast<int>( ::QInputMethodEvent::Ruby), 81},
    {sipName_Selection, static_cast<int>( ::QInputMethodEvent::Selection), 81},
    {sipName_TextFormat, static_cast<int>( ::QInputMethodEvent::TextFormat), 81},
};
