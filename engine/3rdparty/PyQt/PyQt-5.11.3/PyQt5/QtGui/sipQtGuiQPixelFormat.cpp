...
static sipEnumMemberDef enummembers_QPixelFormat[] = {
    {sipName_Alpha, static_cast<int>( ::QPixelFormat::Alpha), 229},
    {sipName_AtBeginning, static_cast<int>( ::QPixelFormat::AtBeginning), 225},
    {sipName_AtEnd, static_cast<int>( ::QPixelFormat::AtEnd), 225},
    {sipName_BGR, static_cast<int>( ::QPixelFormat::BGR), 229},
    {sipName_BigEndian, static_cast<int>( ::QPixelFormat::BigEndian), 228},
    {sipName_CMYK, static_cast<int>( ::QPixelFormat::CMYK), 229},
    {sipName_CurrentSystemEndian, static_cast<int>( ::QPixelFormat::CurrentSystemEndian), 228},
    {sipName_FloatingPoint, static_cast<int>( ::QPixelFormat::FloatingPoint), 230},
    {sipName_Grayscale, static_cast<int>( ::QPixelFormat::Grayscale), 229},
    {sipName_HSL, static_cast<int>( ::QPixelFormat::HSL), 229},
    {sipName_HSV, static_cast<int>( ::QPixelFormat::HSV), 229},
    {sipName_IMC1, static_cast<int>( ::QPixelFormat::IMC1), 231},
    {sipName_IMC2, static_cast<int>( ::QPixelFormat::IMC2), 231},
    {sipName_IMC3, static_cast<int>( ::QPixelFormat::IMC3), 231},
    {sipName_IMC4, static_cast<int>( ::QPixelFormat::IMC4), 231},
    {sipName_IgnoresAlpha, static_cast<int>( ::QPixelFormat::IgnoresAlpha), 227},
    {sipName_Indexed, static_cast<int>( ::QPixelFormat::Indexed), 229},
    {sipName_LittleEndian, static_cast<int>( ::QPixelFormat::LittleEndian), 228},
    {sipName_NV12, static_cast<int>( ::QPixelFormat::NV12), 231},
    {sipName_NV21, static_cast<int>( ::QPixelFormat::NV21), 231},
    {sipName_NotPremultiplied, static_cast<int>( ::QPixelFormat::NotPremultiplied), 226},
    {sipName_Premultiplied, static_cast<int>( ::QPixelFormat::Premultiplied), 226},
    {sipName_RGB, static_cast<int>( ::QPixelFormat::RGB), 229},
    {sipName_UYVY, static_cast<int>( ::QPixelFormat::UYVY), 231},
    {sipName_UnsignedByte, static_cast<int>( ::QPixelFormat::UnsignedByte), 230},
    {sipName_UnsignedInteger, static_cast<int>( ::QPixelFormat::UnsignedInteger), 230},
    {sipName_UnsignedShort, static_cast<int>( ::QPixelFormat::UnsignedShort), 230},
    {sipName_UsesAlpha, static_cast<int>( ::QPixelFormat::UsesAlpha), 227},
    {sipName_Y16, static_cast<int>( ::QPixelFormat::Y16), 231},
    {sipName_Y8, static_cast<int>( ::QPixelFormat::Y8), 231},
    {sipName_YUV, static_cast<int>( ::QPixelFormat::YUV), 229},
    {sipName_YUV411, static_cast<int>( ::QPixelFormat::YUV411), 231},
    {sipName_YUV420P, static_cast<int>( ::QPixelFormat::YUV420P), 231},
    {sipName_YUV420SP, static_cast<int>( ::QPixelFormat::YUV420SP), 231},
    {sipName_YUV422, static_cast<int>( ::QPixelFormat::YUV422), 231},
    {sipName_YUV444, static_cast<int>( ::QPixelFormat::YUV444), 231},
    {sipName_YUYV, static_cast<int>( ::QPixelFormat::YUYV), 231},
    {sipName_YV12, static_cast<int>( ::QPixelFormat::YV12), 231},
};
