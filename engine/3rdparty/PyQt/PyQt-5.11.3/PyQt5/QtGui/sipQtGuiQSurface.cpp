...
static sipEnumMemberDef enummembers_QSurface[] = {
    {sipName_Offscreen, static_cast<int>( ::QSurface::Offscreen), 270},
    {sipName_OpenGLSurface, static_cast<int>( ::QSurface::OpenGLSurface), 271},
    {sipName_OpenVGSurface, static_cast<int>( ::QSurface::OpenVGSurface), 271},
    {sipName_RasterGLSurface, static_cast<int>( ::QSurface::RasterGLSurface), 271},
    {sipName_RasterSurface, static_cast<int>( ::QSurface::RasterSurface), 271},
    {sipName_VulkanSurface, static_cast<int>( ::QSurface::VulkanSurface), 271},
    {sipName_Window, static_cast<int>( ::QSurface::Window), 270},
};
