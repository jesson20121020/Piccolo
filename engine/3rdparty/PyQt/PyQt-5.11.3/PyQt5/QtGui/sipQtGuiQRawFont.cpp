...
static sipEnumMemberDef enummembers_QRawFont[] = {
    {sipName_KernedAdvances, static_cast<int>( ::QRawFont::KernedAdvances), 245},
    {sipName_PixelAntialiasing, static_cast<int>( ::QRawFont::PixelAntialiasing), 244},
    {sipName_SeparateAdvances, static_cast<int>( ::QRawFont::SeparateAdvances), 245},
    {sipName_SubPixelAntialiasing, static_cast<int>( ::QRawFont::SubPixelAntialiasing), 244},
    {sipName_UseDesignMetrics, static_cast<int>( ::QRawFont::UseDesignMetrics), 245},
};
