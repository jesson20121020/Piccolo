...
static sipEnumMemberDef enummembers_QTextFormat[] = {
    {sipName_AnchorHref, static_cast<int>( ::QTextFormat::AnchorHref), 310},
    {sipName_AnchorName, static_cast<int>( ::QTextFormat::AnchorName), 310},
    {sipName_BackgroundBrush, static_cast<int>( ::QTextFormat::BackgroundBrush), 310},
    {sipName_BackgroundImageUrl, static_cast<int>( ::QTextFormat::BackgroundImageUrl), 310},
    {sipName_BlockAlignment, static_cast<int>( ::QTextFormat::BlockAlignment), 310},
    {sipName_BlockBottomMargin, static_cast<int>( ::QTextFormat::BlockBottomMargin), 310},
    {sipName_BlockFormat, static_cast<int>( ::QTextFormat::BlockFormat), 306},
    {sipName_BlockIndent, static_cast<int>( ::QTextFormat::BlockIndent), 310},
    {sipName_BlockLeftMargin, static_cast<int>( ::QTextFormat::BlockLeftMargin), 310},
    {sipName_BlockNonBreakableLines, static_cast<int>( ::QTextFormat::BlockNonBreakableLines), 310},
    {sipName_BlockRightMargin, static_cast<int>( ::QTextFormat::BlockRightMargin), 310},
    {sipName_BlockTopMargin, static_cast<int>( ::QTextFormat::BlockTopMargin), 310},
    {sipName_BlockTrailingHorizontalRulerWidth, static_cast<int>( ::QTextFormat::BlockTrailingHorizontalRulerWidth), 310},
    {sipName_CharFormat, static_cast<int>( ::QTextFormat::CharFormat), 306},
    {sipName_CssFloat, static_cast<int>( ::QTextFormat::CssFloat), 310},
    {sipName_FirstFontProperty, static_cast<int>( ::QTextFormat::FirstFontProperty), 310},
    {sipName_FontCapitalization, static_cast<int>( ::QTextFormat::FontCapitalization), 310},
    {sipName_FontFamily, static_cast<int>( ::QTextFormat::FontFamily), 310},
    {sipName_FontFixedPitch, static_cast<int>( ::QTextFormat::FontFixedPitch), 310},
    {sipName_FontHintingPreference, static_cast<int>( ::QTextFormat::FontHintingPreference), 310},
    {sipName_FontItalic, static_cast<int>( ::QTextFormat::FontItalic), 310},
    {sipName_FontKerning, static_cast<int>( ::QTextFormat::FontKerning), 310},
    {sipName_FontLetterSpacing, static_cast<int>( ::QTextFormat::FontLetterSpacing), 310},
    {sipName_FontLetterSpacingType, static_cast<int>( ::QTextFormat::FontLetterSpacingType), 310},
    {sipName_FontOverline, static_cast<int>( ::QTextFormat::FontOverline), 310},
    {sipName_FontPixelSize, static_cast<int>( ::QTextFormat::FontPixelSize), 310},
    {sipName_FontPointSize, static_cast<int>( ::QTextFormat::FontPointSize), 310},
    {sipName_FontSizeAdjustment, static_cast<int>( ::QTextFormat::FontSizeAdjustment), 310},
    {sipName_FontSizeIncrement, static_cast<int>( ::QTextFormat::FontSizeIncrement), 310},
    {sipName_FontStretch, static_cast<int>( ::QTextFormat::FontStretch), 310},
    {sipName_FontStrikeOut, static_cast<int>( ::QTextFormat::FontStrikeOut), 310},
    {sipName_FontStyleHint, static_cast<int>( ::QTextFormat::FontStyleHint), 310},
    {sipName_FontStyleStrategy, static_cast<int>( ::QTextFormat::FontStyleStrategy), 310},
    {sipName_FontUnderline, static_cast<int>( ::QTextFormat::FontUnderline), 310},
    {sipName_FontWeight, static_cast<int>( ::QTextFormat::FontWeight), 310},
    {sipName_FontWordSpacing, static_cast<int>( ::QTextFormat::FontWordSpacing), 310},
    {sipName_ForegroundBrush, static_cast<int>( ::QTextFormat::ForegroundBrush), 310},
    {sipName_FrameBorder, static_cast<int>( ::QTextFormat::FrameBorder), 310},
    {sipName_FrameBorderBrush, static_cast<int>( ::QTextFormat::FrameBorderBrush), 310},
    {sipName_FrameBorderStyle, static_cast<int>( ::QTextFormat::FrameBorderStyle), 310},
    {sipName_FrameBottomMargin, static_cast<int>( ::QTextFormat::FrameBottomMargin), 310},
    {sipName_FrameFormat, static_cast<int>( ::QTextFormat::FrameFormat), 306},
    {sipName_FrameHeight, static_cast<int>( ::QTextFormat::FrameHeight), 310},
    {sipName_FrameLeftMargin, static_cast<int>( ::QTextFormat::FrameLeftMargin), 310},
    {sipName_FrameMargin, static_cast<int>( ::QTextFormat::FrameMargin), 310},
    {sipName_FramePadding, static_cast<int>( ::QTextFormat::FramePadding), 310},
    {sipName_FrameRightMargin, static_cast<int>( ::QTextFormat::FrameRightMargin), 310},
    {sipName_FrameTopMargin, static_cast<int>( ::QTextFormat::FrameTopMargin), 310},
    {sipName_FrameWidth, static_cast<int>( ::QTextFormat::FrameWidth), 310},
    {sipName_FullWidthSelection, static_cast<int>( ::QTextFormat::FullWidthSelection), 310},
    {sipName_ImageHeight, static_cast<int>( ::QTextFormat::ImageHeight), 310},
    {sipName_ImageName, static_cast<int>( ::QTextFormat::ImageName), 310},
    {sipName_ImageObject, static_cast<int>( ::QTextFormat::ImageObject), 307},
    {sipName_ImageWidth, static_cast<int>( ::QTextFormat::ImageWidth), 310},
    {sipName_InvalidFormat, static_cast<int>( ::QTextFormat::InvalidFormat), 306},
    {sipName_IsAnchor, static_cast<int>( ::QTextFormat::IsAnchor), 310},
    {sipName_LastFontProperty, static_cast<int>( ::QTextFormat::LastFontProperty), 310},
    {sipName_LayoutDirection, static_cast<int>( ::QTextFormat::LayoutDirection), 310},
    {sipName_LineHeight, static_cast<int>( ::QTextFormat::LineHeight), 310},
    {sipName_LineHeightType, static_cast<int>( ::QTextFormat::LineHeightType), 310},
    {sipName_ListFormat, static_cast<int>( ::QTextFormat::ListFormat), 306},
    {sipName_ListIndent, static_cast<int>( ::QTextFormat::ListIndent), 310},
    {sipName_ListNumberPrefix, static_cast<int>( ::QTextFormat::ListNumberPrefix), 310},
    {sipName_ListNumberSuffix, static_cast<int>( ::QTextFormat::ListNumberSuffix), 310},
    {sipName_ListStyle, static_cast<int>( ::QTextFormat::ListStyle), 310},
    {sipName_NoObject, static_cast<int>( ::QTextFormat::NoObject), 307},
    {sipName_ObjectIndex, static_cast<int>( ::QTextFormat::ObjectIndex), 310},
    {sipName_ObjectType, static_cast<int>( ::QTextFormat::ObjectType), 310},
    {sipName_OutlinePen, static_cast<int>( ::QTextFormat::OutlinePen), 310},
    {sipName_PageBreakPolicy, static_cast<int>( ::QTextFormat::PageBreakPolicy), 310},
    {sipName_PageBreak_AlwaysAfter, static_cast<int>( ::QTextFormat::PageBreak_AlwaysAfter), 308},
    {sipName_PageBreak_AlwaysBefore, static_cast<int>( ::QTextFormat::PageBreak_AlwaysBefore), 308},
    {sipName_PageBreak_Auto, static_cast<int>( ::QTextFormat::PageBreak_Auto), 308},
    {sipName_TabPositions, static_cast<int>( ::QTextFormat::TabPositions), 310},
    {sipName_TableCellBottomPadding, static_cast<int>( ::QTextFormat::TableCellBottomPadding), 310},
    {sipName_TableCellColumnSpan, static_cast<int>( ::QTextFormat::TableCellColumnSpan), 310},
    {sipName_TableCellLeftPadding, static_cast<int>( ::QTextFormat::TableCellLeftPadding), 310},
    {sipName_TableCellObject, static_cast<int>( ::QTextFormat::TableCellObject), 307},
    {sipName_TableCellPadding, static_cast<int>( ::QTextFormat::TableCellPadding), 310},
    {sipName_TableCellRightPadding, static_cast<int>( ::QTextFormat::TableCellRightPadding), 310},
    {sipName_TableCellRowSpan, static_cast<int>( ::QTextFormat::TableCellRowSpan), 310},
    {sipName_TableCellSpacing, static_cast<int>( ::QTextFormat::TableCellSpacing), 310},
    {sipName_TableCellTopPadding, static_cast<int>( ::QTextFormat::TableCellTopPadding), 310},
    {sipName_TableColumnWidthConstraints, static_cast<int>( ::QTextFormat::TableColumnWidthConstraints), 310},
    {sipName_TableColumns, static_cast<int>( ::QTextFormat::TableColumns), 310},
    {sipName_TableFormat, static_cast<int>( ::QTextFormat::TableFormat), 306},
    {sipName_TableHeaderRowCount, static_cast<int>( ::QTextFormat::TableHeaderRowCount), 310},
    {sipName_TableObject, static_cast<int>( ::QTextFormat::TableObject), 307},
    {sipName_TextIndent, static_cast<int>( ::QTextFormat::TextIndent), 310},
    {sipName_TextOutline, static_cast<int>( ::QTextFormat::TextOutline), 310},
    {sipName_TextToolTip, static_cast<int>( ::QTextFormat::TextToolTip), 310},
    {sipName_TextUnderlineColor, static_cast<int>( ::QTextFormat::TextUnderlineColor), 310},
    {sipName_TextUnderlineStyle, static_cast<int>( ::QTextFormat::TextUnderlineStyle), 310},
    {sipName_TextVerticalAlignment, static_cast<int>( ::QTextFormat::TextVerticalAlignment), 310},
    {sipName_UserFormat, static_cast<int>( ::QTextFormat::UserFormat), 306},
    {sipName_UserObject, static_cast<int>( ::QTextFormat::UserObject), 307},
    {sipName_UserProperty, static_cast<int>( ::QTextFormat::UserProperty), 310},
};
