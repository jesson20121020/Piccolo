...
static sipEnumMemberDef enummembers_QSessionManager[] = {
    {sipName_RestartAnyway, static_cast<int>( ::QSessionManager::RestartAnyway), 258},
    {sipName_RestartIfRunning, static_cast<int>( ::QSessionManager::RestartIfRunning), 258},
    {sipName_RestartImmediately, static_cast<int>( ::QSessionManager::RestartImmediately), 258},
    {sipName_RestartNever, static_cast<int>( ::QSessionManager::RestartNever), 258},
};
