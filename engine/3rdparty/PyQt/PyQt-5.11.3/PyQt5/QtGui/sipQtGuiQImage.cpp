...
public:
    ...
    int sipProtectVirt_metric(bool, ::QPaintDevice::PaintDeviceMetric) const;
     ::QImage sipProtect_smoothScaled(int,int) const;
...
int sipQImage::sipProtectVirt_metric(bool sipSelfWasArg, ::QPaintDevice::PaintDeviceMetric a0) const
{
 ...
 ::QImage sipQImage::sipProtect_smoothScaled(int a0,int a1) const
{
    return  ::QImage::smoothScaled(a0,a1);
}
...
extern "C" {static PyObject *meth_QImage_smoothScaled(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QImage_smoothScaled(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "Bii", &sipSelf, sipType_QImage, &sipCpp, &a0, &a1))
        {
             ::QImage*sipRes;

            sipRes = new  ::QImage(sipCpp->sipProtect_smoothScaled(a0,a1));
...
static sipEncodedTypeDef supers_QImage[] = {{192, 255, 1}};
...
static PyMethodDef methods_QImage[] = {
    ...
    {SIP_MLNAME_CAST(sipName_smoothScaled), (PyCFunction)meth_QImage_smoothScaled, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QImage_smoothScaled)},
...
static sipEnumMemberDef enummembers_QImage[] = {
    {sipName_Format_A2BGR30_Premultiplied, static_cast<int>( ::QImage::Format_A2BGR30_Premultiplied), 66},
    {sipName_Format_A2RGB30_Premultiplied, static_cast<int>( ::QImage::Format_A2RGB30_Premultiplied), 66},
    {sipName_Format_ARGB32, static_cast<int>( ::QImage::Format_ARGB32), 66},
    {sipName_Format_ARGB32_Premultiplied, static_cast<int>( ::QImage::Format_ARGB32_Premultiplied), 66},
    {sipName_Format_ARGB4444_Premultiplied, static_cast<int>( ::QImage::Format_ARGB4444_Premultiplied), 66},
    {sipName_Format_ARGB6666_Premultiplied, static_cast<int>( ::QImage::Format_ARGB6666_Premultiplied), 66},
    {sipName_Format_ARGB8555_Premultiplied, static_cast<int>( ::QImage::Format_ARGB8555_Premultiplied), 66},
    {sipName_Format_ARGB8565_Premultiplied, static_cast<int>( ::QImage::Format_ARGB8565_Premultiplied), 66},
    {sipName_Format_Alpha8, static_cast<int>( ::QImage::Format_Alpha8), 66},
    {sipName_Format_BGR30, static_cast<int>( ::QImage::Format_BGR30), 66},
    {sipName_Format_Grayscale8, static_cast<int>( ::QImage::Format_Grayscale8), 66},
    {sipName_Format_Indexed8, static_cast<int>( ::QImage::Format_Indexed8), 66},
    {sipName_Format_Invalid, static_cast<int>( ::QImage::Format_Invalid), 66},
    {sipName_Format_Mono, static_cast<int>( ::QImage::Format_Mono), 66},
    {sipName_Format_MonoLSB, static_cast<int>( ::QImage::Format_MonoLSB), 66},
    {sipName_Format_RGB16, static_cast<int>( ::QImage::Format_RGB16), 66},
    {sipName_Format_RGB30, static_cast<int>( ::QImage::Format_RGB30), 66},
    {sipName_Format_RGB32, static_cast<int>( ::QImage::Format_RGB32), 66},
    {sipName_Format_RGB444, static_cast<int>( ::QImage::Format_RGB444), 66},
    {sipName_Format_RGB555, static_cast<int>( ::QImage::Format_RGB555), 66},
    {sipName_Format_RGB666, static_cast<int>( ::QImage::Format_RGB666), 66},
    {sipName_Format_RGB888, static_cast<int>( ::QImage::Format_RGB888), 66},
    {sipName_Format_RGBA8888, static_cast<int>( ::QImage::Format_RGBA8888), 66},
    {sipName_Format_RGBA8888_Premultiplied, static_cast<int>( ::QImage::Format_RGBA8888_Premultiplied), 66},
    {sipName_Format_RGBX8888, static_cast<int>( ::QImage::Format_RGBX8888), 66},
    {sipName_InvertRgb, static_cast<int>( ::QImage::InvertRgb), 67},
    {sipName_InvertRgba, static_cast<int>( ::QImage::InvertRgba), 67},
};
