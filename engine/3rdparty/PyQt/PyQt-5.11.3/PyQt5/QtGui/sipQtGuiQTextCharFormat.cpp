...
static sipEncodedTypeDef supers_QTextCharFormat[] = {{305, 255, 1}};
...
static sipEnumMemberDef enummembers_QTextCharFormat[] = {
    {sipName_AlignBaseline, static_cast<int>( ::QTextCharFormat::AlignBaseline), 292},
    {sipName_AlignBottom, static_cast<int>( ::QTextCharFormat::AlignBottom), 292},
    {sipName_AlignMiddle, static_cast<int>( ::QTextCharFormat::AlignMiddle), 292},
    {sipName_AlignNormal, static_cast<int>( ::QTextCharFormat::AlignNormal), 292},
    {sipName_AlignSubScript, static_cast<int>( ::QTextCharFormat::AlignSubScript), 292},
    {sipName_AlignSuperScript, static_cast<int>( ::QTextCharFormat::AlignSuperScript), 292},
    {sipName_AlignTop, static_cast<int>( ::QTextCharFormat::AlignTop), 292},
    {sipName_DashDotDotLine, static_cast<int>( ::QTextCharFormat::DashDotDotLine), 291},
    {sipName_DashDotLine, static_cast<int>( ::QTextCharFormat::DashDotLine), 291},
    {sipName_DashUnderline, static_cast<int>( ::QTextCharFormat::DashUnderline), 291},
    {sipName_DotLine, static_cast<int>( ::QTextCharFormat::DotLine), 291},
    {sipName_FontPropertiesAll, static_cast<int>( ::QTextCharFormat::FontPropertiesAll), 290},
    {sipName_FontPropertiesSpecifiedOnly, static_cast<int>( ::QTextCharFormat::FontPropertiesSpecifiedOnly), 290},
    {sipName_NoUnderline, static_cast<int>( ::QTextCharFormat::NoUnderline), 291},
    {sipName_SingleUnderline, static_cast<int>( ::QTextCharFormat::SingleUnderline), 291},
    {sipName_SpellCheckUnderline, static_cast<int>( ::QTextCharFormat::SpellCheckUnderline), 291},
    {sipName_WaveUnderline, static_cast<int>( ::QTextCharFormat::WaveUnderline), 291},
};
