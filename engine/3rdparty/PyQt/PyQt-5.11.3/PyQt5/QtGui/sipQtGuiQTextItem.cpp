...
static sipEnumMemberDef enummembers_QTextItem[] = {
    {sipName_Overline, static_cast<int>( ::QTextItem::Overline), 320},
    {sipName_RightToLeft, static_cast<int>( ::QTextItem::RightToLeft), 320},
    {sipName_StrikeOut, static_cast<int>( ::QTextItem::StrikeOut), 320},
    {sipName_Underline, static_cast<int>( ::QTextItem::Underline), 320},
};
