...
PyDoc_STRVAR(doc_QGraphicsScale_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QGraphicsScale_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QGraphicsScale_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScale_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScale_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScale_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsScale_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsScale_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QGraphicsScale_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QGraphicsScale_update, "update(self)");
...
static sipEncodedTypeDef supers_QGraphicsScale[] = {{159, 255, 1}};
