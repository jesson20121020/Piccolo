...
PyDoc_STRVAR(doc_QPinchGesture_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QPinchGesture_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QPinchGesture_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QPinchGesture_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QPinchGesture_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QPinchGesture_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPinchGesture_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPinchGesture_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QPinchGesture_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QPinchGesture[] = {{103, 255, 1}};
