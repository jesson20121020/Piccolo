...
PyDoc_STRVAR(doc_QFormLayout_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QFormLayout_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QFormLayout_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QFormLayout_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QFormLayout_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFormLayout_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFormLayout_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QFormLayout_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QFormLayout_widgetEvent, "widgetEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QFormLayout_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QFormLayout_addChildLayout, "addChildLayout(self, QLayout)");
...
PyDoc_STRVAR(doc_QFormLayout_addChildWidget, "addChildWidget(self, QWidget)");
...
PyDoc_STRVAR(doc_QFormLayout_alignmentRect, "alignmentRect(self, QRect) -> QRect");
...
static PyObject *meth_QFormLayout_takeRow(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "Bi", &sipSelf, sipType_QFormLayout, &sipCpp, &a0))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_QFormLayout_TakeRowResult,NULL);
        }
    }
...
static sipEncodedTypeDef supers_QFormLayout[] = {{187, 255, 1}};
...
static PyMethodDef methods_QFormLayout[] = {
    ...
    {SIP_MLNAME_CAST(sipName_removeRow), meth_QFormLayout_removeRow, METH_VARARGS, SIP_MLDOC_CAST(doc_QFormLayout_removeRow)},
    ...
    {SIP_MLNAME_CAST(sipName_takeRow), meth_QFormLayout_takeRow, METH_VARARGS, SIP_MLDOC_CAST(doc_QFormLayout_takeRow)},
