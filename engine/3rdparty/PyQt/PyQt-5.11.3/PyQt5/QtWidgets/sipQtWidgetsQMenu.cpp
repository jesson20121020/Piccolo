...
PyDoc_STRVAR(doc_QMenu_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QMenu_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QMenu_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QMenu_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMenu_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMenu_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMenu_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QMenu_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QMenu_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QMenu_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QMenu_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QMenu_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QMenu_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QMenu_resizeEvent, "resizeEvent(self, QResizeEvent)");
...
PyDoc_STRVAR(doc_QMenu_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QMenu_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QMenu_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QMenu_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QMenu_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QMenu_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QMenu_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QMenu_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QMenu_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QMenu_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QMenu_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QMenu_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QMenu_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QMenu_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMenu_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMenu_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QMenu_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QMenu_initPainter, "initPainter(self, QPainter)");
