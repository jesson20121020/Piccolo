...
PyDoc_STRVAR(doc_QGraphicsScene_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QGraphicsScene_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QGraphicsScene_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScene_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScene_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGraphicsScene_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsScene_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsScene_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QGraphicsScene_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEnumMemberDef enummembers_QGraphicsScene[] = {
    {sipName_AllLayers, static_cast<int>( ::QGraphicsScene::AllLayers), 145},
    {sipName_BackgroundLayer, static_cast<int>( ::QGraphicsScene::BackgroundLayer), 145},
    {sipName_BspTreeIndex, static_cast<int>( ::QGraphicsScene::BspTreeIndex), 144},
    {sipName_ForegroundLayer, static_cast<int>( ::QGraphicsScene::ForegroundLayer), 145},
    {sipName_ItemLayer, static_cast<int>( ::QGraphicsScene::ItemLayer), 145},
    {sipName_NoIndex, static_cast<int>( ::QGraphicsScene::NoIndex), 144},
};
