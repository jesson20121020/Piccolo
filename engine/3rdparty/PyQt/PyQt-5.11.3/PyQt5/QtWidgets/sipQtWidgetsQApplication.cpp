...
PyDoc_STRVAR(doc_QApplication_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QApplication_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QApplication_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QApplication_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QApplication_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QApplication_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QApplication_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QApplication_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QApplication_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
