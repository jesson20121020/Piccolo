...
static sipEncodedTypeDef supers_QGraphicsSceneContextMenuEvent[] = {{150, 255, 1}};
...
static sipEnumMemberDef enummembers_QGraphicsSceneContextMenuEvent[] = {
    {sipName_Keyboard, static_cast<int>( ::QGraphicsSceneContextMenuEvent::Keyboard), 148},
    {sipName_Mouse, static_cast<int>( ::QGraphicsSceneContextMenuEvent::Mouse), 148},
    {sipName_Other, static_cast<int>( ::QGraphicsSceneContextMenuEvent::Other), 148},
};
