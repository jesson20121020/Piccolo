...
PyDoc_STRVAR(doc_QComboBox_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QComboBox_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QComboBox_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QComboBox_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QComboBox_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QComboBox_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QComboBox_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QComboBox_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QComboBox_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QComboBox_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QComboBox_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QComboBox_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QComboBox_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QComboBox_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QComboBox_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QComboBox_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QComboBox_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QComboBox_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QComboBox_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QComboBox_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QComboBox_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QComboBox_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QComboBox_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QComboBox_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QComboBox_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QComboBox_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QComboBox_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QComboBox_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QComboBox_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QComboBox_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QComboBox_initPainter, "initPainter(self, QPainter)");
