...
PyDoc_STRVAR(doc_QCommonStyle_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QCommonStyle_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QCommonStyle_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QCommonStyle_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QCommonStyle_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QCommonStyle_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QCommonStyle_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QCommonStyle_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QCommonStyle_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
