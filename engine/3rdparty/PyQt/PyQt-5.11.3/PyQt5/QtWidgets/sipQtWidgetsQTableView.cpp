...
void sipQTableView::sipProtect_initStyleOption( ::QStyleOptionFrame*a0) const
{
...
void sipQTableView::sipProtect_setViewportMargins(const  ::QMargins& a0)
{
 ...
 ::QMargins sipQTableView::sipProtect_viewportMargins() const
{
...
PyDoc_STRVAR(doc_QTableView_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTableView_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTableView_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTableView_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTableView_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTableView_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTableView_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTableView_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QTableView_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QTableView_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTableView_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTableView_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QTableView_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QTableView_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QTableView_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QTableView_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QTableView_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QTableView_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QTableView_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QTableView_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QTableView_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QTableView_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QTableView_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QTableView_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QTableView_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QTableView_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QTableView_changeEvent, "changeEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTableView_drawFrame, "drawFrame(self, QPainter)");
...
PyDoc_STRVAR(doc_QTableView_initStyleOption, "initStyleOption(self, QStyleOptionFrame)");

extern "C" {static PyObject *meth_QTableView_initStyleOption(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QTableView_initStyleOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "BJ8", &sipSelf, sipType_QTableView, &sipCpp, sipType_QStyleOptionFrame, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QTableView, sipName_initStyleOption, doc_QTableView_initStyleOption);

    return NULL;
}


PyDoc_STRVAR(doc_QTableView_setViewportMargins, "setViewportMargins(self, int, int, int, int)\n"
...
PyDoc_STRVAR(doc_QTableView_viewportMargins, "viewportMargins(self) -> QMargins");

extern "C" {static PyObject *meth_QTableView_viewportMargins(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QTableView_viewportMargins(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QTableView, sipName_viewportMargins, doc_QTableView_viewportMargins);

    return NULL;
}


PyDoc_STRVAR(doc_QTableView_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QTableView_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QTableView_eventFilter, "eventFilter(self, QObject, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QTableView_edit, "edit(self, QModelIndex)\n"
...
PyDoc_STRVAR(doc_QTableView_dataChanged, "dataChanged(self, QModelIndex, QModelIndex, roles: Iterable[int] = [])");
...
PyDoc_STRVAR(doc_QTableView_rowsInserted, "rowsInserted(self, QModelIndex, int, int)");
...
PyDoc_STRVAR(doc_QTableView_rowsAboutToBeRemoved, "rowsAboutToBeRemoved(self, QModelIndex, int, int)");
...
PyDoc_STRVAR(doc_QTableView_updateEditorData, "updateEditorData(self)");
...
PyDoc_STRVAR(doc_QTableView_updateEditorGeometries, "updateEditorGeometries(self)");
...
PyDoc_STRVAR(doc_QTableView_verticalScrollbarValueChanged, "verticalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QTableView_horizontalScrollbarValueChanged, "horizontalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QTableView_closeEditor, "closeEditor(self, QWidget, QAbstractItemDelegate.EndEditHint)");
...
PyDoc_STRVAR(doc_QTableView_commitData, "commitData(self, QWidget)");
...
PyDoc_STRVAR(doc_QTableView_editorDestroyed, "editorDestroyed(self, QObject)");
...
PyDoc_STRVAR(doc_QTableView_selectionCommand, "selectionCommand(self, QModelIndex, event: QEvent = None) -> QItemSelectionModel.SelectionFlags");
...
PyDoc_STRVAR(doc_QTableView_startDrag, "startDrag(self, Union[Qt.DropActions, Qt.DropAction])");
...
PyDoc_STRVAR(doc_QTableView_state, "state(self) -> QAbstractItemView.State");
...
PyDoc_STRVAR(doc_QTableView_setState, "setState(self, QAbstractItemView.State)");
...
PyDoc_STRVAR(doc_QTableView_scheduleDelayedItemsLayout, "scheduleDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QTableView_executeDelayedItemsLayout, "executeDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QTableView_scrollDirtyRegion, "scrollDirtyRegion(self, int, int)");
...
PyDoc_STRVAR(doc_QTableView_setDirtyRegion, "setDirtyRegion(self, QRegion)");
...
PyDoc_STRVAR(doc_QTableView_dirtyRegionOffset, "dirtyRegionOffset(self) -> QPoint");
...
PyDoc_STRVAR(doc_QTableView_event, "event(self, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QTableView_viewportEvent, "viewportEvent(self, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QTableView_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QTableView_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QTableView_mouseReleaseEvent, "mouseReleaseEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QTableView_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QTableView_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QTableView_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QTableView_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QTableView_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QTableView_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QTableView_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QTableView_keyPressEvent, "keyPressEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QTableView_resizeEvent, "resizeEvent(self, QResizeEvent)");
...
PyDoc_STRVAR(doc_QTableView_dropIndicatorPosition, "dropIndicatorPosition(self) -> QAbstractItemView.DropIndicatorPosition");
...
PyDoc_STRVAR(doc_QTableView_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QTableView_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
static PyMethodDef methods_QTableView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_initStyleOption), (PyCFunction)meth_QTableView_initStyleOption, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_viewportMargins), (PyCFunction)meth_QTableView_viewportMargins, METH_VARARGS|METH_KEYWORDS, NULL},
