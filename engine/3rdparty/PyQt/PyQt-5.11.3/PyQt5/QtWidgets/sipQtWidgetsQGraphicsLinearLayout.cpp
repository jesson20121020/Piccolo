...
PyDoc_STRVAR(doc_QGraphicsLinearLayout_setGraphicsItem, "setGraphicsItem(self, QGraphicsItem)");
...
PyDoc_STRVAR(doc_QGraphicsLinearLayout_setOwnedByLayout, "setOwnedByLayout(self, bool)");
...
PyDoc_STRVAR(doc_QGraphicsLinearLayout_addChildLayoutItem, "addChildLayoutItem(self, QGraphicsLayoutItem)");
...
static sipEncodedTypeDef supers_QGraphicsLinearLayout[] = {{129, 255, 1}};
