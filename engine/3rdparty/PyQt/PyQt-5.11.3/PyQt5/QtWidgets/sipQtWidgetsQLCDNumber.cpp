...
void sipQLCDNumber::sipProtect_initStyleOption( ::QStyleOptionFrame*a0) const
{
...
PyDoc_STRVAR(doc_QLCDNumber_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QLCDNumber_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QLCDNumber_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QLCDNumber_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QLCDNumber_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QLCDNumber_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QLCDNumber_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_mouseReleaseEvent, "mouseReleaseEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_keyPressEvent, "keyPressEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_resizeEvent, "resizeEvent(self, QResizeEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QLCDNumber_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QLCDNumber_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QLCDNumber_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QLCDNumber_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QLCDNumber_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QLCDNumber_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QLCDNumber_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QLCDNumber_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QLCDNumber_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QLCDNumber_changeEvent, "changeEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QLCDNumber_drawFrame, "drawFrame(self, QPainter)");
...
PyDoc_STRVAR(doc_QLCDNumber_initStyleOption, "initStyleOption(self, QStyleOptionFrame)");

extern "C" {static PyObject *meth_QLCDNumber_initStyleOption(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QLCDNumber_initStyleOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "BJ8", &sipSelf, sipType_QLCDNumber, &sipCpp, sipType_QStyleOptionFrame, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QLCDNumber, sipName_initStyleOption, doc_QLCDNumber_initStyleOption);
...
static sipEncodedTypeDef supers_QLCDNumber[] = {{99, 255, 1}};
...
static PyMethodDef methods_QLCDNumber[] = {
    ...
    {SIP_MLNAME_CAST(sipName_initStyleOption), (PyCFunction)meth_QLCDNumber_initStyleOption, METH_VARARGS|METH_KEYWORDS, NULL},
...
static sipEnumMemberDef enummembers_QLCDNumber[] = {
    {sipName_Bin, static_cast<int>( ::QLCDNumber::Bin), 184},
    {sipName_Dec, static_cast<int>( ::QLCDNumber::Dec), 184},
    {sipName_Filled, static_cast<int>( ::QLCDNumber::Filled), 185},
    {sipName_Flat, static_cast<int>( ::QLCDNumber::Flat), 185},
    {sipName_Hex, static_cast<int>( ::QLCDNumber::Hex), 184},
    {sipName_Oct, static_cast<int>( ::QLCDNumber::Oct), 184},
    {sipName_Outline, static_cast<int>( ::QLCDNumber::Outline), 185},
};
