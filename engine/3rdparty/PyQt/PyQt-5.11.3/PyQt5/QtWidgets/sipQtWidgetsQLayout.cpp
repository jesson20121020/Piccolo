...
PyDoc_STRVAR(doc_QLayout_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QLayout_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QLayout_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QLayout_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QLayout_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QLayout_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QLayout_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QLayout_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QLayout[] = {{32, 0, 0}, {189, 255, 1}};
...
static sipEnumMemberDef enummembers_QLayout[] = {
    {sipName_SetDefaultConstraint, static_cast<int>( ::QLayout::SetDefaultConstraint), 188},
    {sipName_SetFixedSize, static_cast<int>( ::QLayout::SetFixedSize), 188},
    {sipName_SetMaximumSize, static_cast<int>( ::QLayout::SetMaximumSize), 188},
    {sipName_SetMinAndMaxSize, static_cast<int>( ::QLayout::SetMinAndMaxSize), 188},
    {sipName_SetMinimumSize, static_cast<int>( ::QLayout::SetMinimumSize), 188},
    {sipName_SetNoConstraint, static_cast<int>( ::QLayout::SetNoConstraint), 188},
};
