...
PyDoc_STRVAR(doc_QAction_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QAction_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QAction_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QAction_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QAction_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QAction_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QAction_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QAction_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QAction_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static PyMethodDef methods_QAction[] = {
    ...
    {SIP_MLNAME_CAST(sipName_isShortcutVisibleInContextMenu), meth_QAction_isShortcutVisibleInContextMenu, METH_VARARGS, SIP_MLDOC_CAST(doc_QAction_isShortcutVisibleInContextMenu)},
    ...
    {SIP_MLNAME_CAST(sipName_setShortcutVisibleInContextMenu), meth_QAction_setShortcutVisibleInContextMenu, METH_VARARGS, SIP_MLDOC_CAST(doc_QAction_setShortcutVisibleInContextMenu)},
