...
PyDoc_STRVAR(doc_QGraphicsRotation_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QGraphicsRotation_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QGraphicsRotation_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QGraphicsRotation_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QGraphicsRotation_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGraphicsRotation_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsRotation_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGraphicsRotation_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QGraphicsRotation_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QGraphicsRotation_update, "update(self)");
...
static sipEncodedTypeDef supers_QGraphicsRotation[] = {{159, 255, 1}};
