...
PyDoc_STRVAR(doc_QInputDialog_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QInputDialog_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QInputDialog_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QInputDialog_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QInputDialog_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QInputDialog_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QInputDialog_event, "event(self, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QInputDialog_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_mouseReleaseEvent, "mouseReleaseEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_paintEvent, "paintEvent(self, QPaintEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_changeEvent, "changeEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QInputDialog_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QInputDialog_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QInputDialog_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QInputDialog_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QInputDialog_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QInputDialog_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QInputDialog_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QInputDialog_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QInputDialog_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QInputDialog_keyPressEvent, "keyPressEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_resizeEvent, "resizeEvent(self, QResizeEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QInputDialog_eventFilter, "eventFilter(self, QObject, QEvent) -> bool");
...
static PyObject *meth_QInputDialog_getDouble(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "J8J1J1dddiJ1d", sipType_QWidget, &a0, sipType_QString,&a1, &a1State, sipType_QString,&a2, &a2State, &a3, &a4, &a5, &a6, sipType_Qt_WindowFlags, &a8, &a8State, &a9))
        {
            double sipRes;
...
static PyMethodDef methods_QInputDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_doubleStep), meth_QInputDialog_doubleStep, METH_VARARGS, SIP_MLDOC_CAST(doc_QInputDialog_doubleStep)},
    ...
    {SIP_MLNAME_CAST(sipName_setDoubleStep), meth_QInputDialog_setDoubleStep, METH_VARARGS, SIP_MLDOC_CAST(doc_QInputDialog_setDoubleStep)},
...
static sipEnumMemberDef enummembers_QInputDialog[] = {
    {sipName_DoubleInput, static_cast<int>( ::QInputDialog::DoubleInput), 177},
    {sipName_IntInput, static_cast<int>( ::QInputDialog::IntInput), 177},
    {sipName_NoButtons, static_cast<int>( ::QInputDialog::NoButtons), 175},
    {sipName_TextInput, static_cast<int>( ::QInputDialog::TextInput), 177},
    {sipName_UseListViewForComboBoxItems, static_cast<int>( ::QInputDialog::UseListViewForComboBoxItems), 175},
    {sipName_UsePlainTextEditForTextInput, static_cast<int>( ::QInputDialog::UsePlainTextEditForTextInput), 175},
};
