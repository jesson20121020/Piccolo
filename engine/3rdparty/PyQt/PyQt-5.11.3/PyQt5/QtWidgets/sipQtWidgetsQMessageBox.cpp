...
PyDoc_STRVAR(doc_QMessageBox_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QMessageBox_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QMessageBox_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMessageBox_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMessageBox_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QMessageBox_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QMessageBox_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_mouseReleaseEvent, "mouseReleaseEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_paintEvent, "paintEvent(self, QPaintEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QMessageBox_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QMessageBox_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QMessageBox_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QMessageBox_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QMessageBox_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMessageBox_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMessageBox_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QMessageBox_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QMessageBox_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QMessageBox_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QMessageBox_eventFilter, "eventFilter(self, QObject, QEvent) -> bool");
