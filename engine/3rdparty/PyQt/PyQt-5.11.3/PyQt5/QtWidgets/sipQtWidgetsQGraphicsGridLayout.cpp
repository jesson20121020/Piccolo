...
PyDoc_STRVAR(doc_QGraphicsGridLayout_setGraphicsItem, "setGraphicsItem(self, QGraphicsItem)");
...
PyDoc_STRVAR(doc_QGraphicsGridLayout_setOwnedByLayout, "setOwnedByLayout(self, bool)");
...
PyDoc_STRVAR(doc_QGraphicsGridLayout_addChildLayoutItem, "addChildLayoutItem(self, QGraphicsLayoutItem)");
...
static sipEncodedTypeDef supers_QGraphicsGridLayout[] = {{129, 255, 1}};
