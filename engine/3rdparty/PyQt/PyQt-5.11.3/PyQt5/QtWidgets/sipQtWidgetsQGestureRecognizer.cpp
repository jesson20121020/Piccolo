...
static sipEnumMemberDef enummembers_QGestureRecognizer[] = {
    {sipName_CancelGesture, static_cast<int>( ::QGestureRecognizer::CancelGesture), 108},
    {sipName_ConsumeEventHint, static_cast<int>( ::QGestureRecognizer::ConsumeEventHint), 108},
    {sipName_FinishGesture, static_cast<int>( ::QGestureRecognizer::FinishGesture), 108},
    {sipName_Ignore, static_cast<int>( ::QGestureRecognizer::Ignore), 108},
    {sipName_MayBeGesture, static_cast<int>( ::QGestureRecognizer::MayBeGesture), 108},
    {sipName_TriggerGesture, static_cast<int>( ::QGestureRecognizer::TriggerGesture), 108},
};
