...
PyDoc_STRVAR(doc_QGridLayout_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QGridLayout_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QGridLayout_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QGridLayout_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGridLayout_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGridLayout_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QGridLayout_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QGridLayout_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QGridLayout_widgetEvent, "widgetEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QGridLayout_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QGridLayout_addChildLayout, "addChildLayout(self, QLayout)");
...
PyDoc_STRVAR(doc_QGridLayout_addChildWidget, "addChildWidget(self, QWidget)");
...
PyDoc_STRVAR(doc_QGridLayout_alignmentRect, "alignmentRect(self, QRect) -> QRect");
...
static sipEncodedTypeDef supers_QGridLayout[] = {{187, 255, 1}};
