...
void sipQListView::sipProtect_initStyleOption( ::QStyleOptionFrame*a0) const
{
...
void sipQListView::sipProtect_setViewportMargins(const  ::QMargins& a0)
{
 ...
 ::QMargins sipQListView::sipProtect_viewportMargins() const
{
...
PyDoc_STRVAR(doc_QListView_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QListView_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QListView_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QListView_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QListView_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QListView_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QListView_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QListView_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QListView_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QListView_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QListView_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QListView_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QListView_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QListView_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QListView_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QListView_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QListView_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QListView_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QListView_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QListView_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QListView_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QListView_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QListView_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QListView_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QListView_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QListView_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QListView_changeEvent, "changeEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QListView_drawFrame, "drawFrame(self, QPainter)");
...
PyDoc_STRVAR(doc_QListView_initStyleOption, "initStyleOption(self, QStyleOptionFrame)");

extern "C" {static PyObject *meth_QListView_initStyleOption(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QListView_initStyleOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "BJ8", &sipSelf, sipType_QListView, &sipCpp, sipType_QStyleOptionFrame, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QListView, sipName_initStyleOption, doc_QListView_initStyleOption);

    return NULL;
}


PyDoc_STRVAR(doc_QListView_setViewportMargins, "setViewportMargins(self, int, int, int, int)\n"
...
PyDoc_STRVAR(doc_QListView_viewportMargins, "viewportMargins(self) -> QMargins");

extern "C" {static PyObject *meth_QListView_viewportMargins(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QListView_viewportMargins(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QListView, sipName_viewportMargins, doc_QListView_viewportMargins);

    return NULL;
}


PyDoc_STRVAR(doc_QListView_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QListView_eventFilter, "eventFilter(self, QObject, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QListView_edit, "edit(self, QModelIndex)\n"
...
PyDoc_STRVAR(doc_QListView_updateEditorData, "updateEditorData(self)");
...
PyDoc_STRVAR(doc_QListView_updateEditorGeometries, "updateEditorGeometries(self)");
...
PyDoc_STRVAR(doc_QListView_verticalScrollbarAction, "verticalScrollbarAction(self, int)");
...
PyDoc_STRVAR(doc_QListView_horizontalScrollbarAction, "horizontalScrollbarAction(self, int)");
...
PyDoc_STRVAR(doc_QListView_verticalScrollbarValueChanged, "verticalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QListView_horizontalScrollbarValueChanged, "horizontalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QListView_closeEditor, "closeEditor(self, QWidget, QAbstractItemDelegate.EndEditHint)");
...
PyDoc_STRVAR(doc_QListView_commitData, "commitData(self, QWidget)");
...
PyDoc_STRVAR(doc_QListView_editorDestroyed, "editorDestroyed(self, QObject)");
...
PyDoc_STRVAR(doc_QListView_selectionCommand, "selectionCommand(self, QModelIndex, event: QEvent = None) -> QItemSelectionModel.SelectionFlags");
...
PyDoc_STRVAR(doc_QListView_state, "state(self) -> QAbstractItemView.State");
...
PyDoc_STRVAR(doc_QListView_setState, "setState(self, QAbstractItemView.State)");
...
PyDoc_STRVAR(doc_QListView_scheduleDelayedItemsLayout, "scheduleDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QListView_executeDelayedItemsLayout, "executeDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QListView_scrollDirtyRegion, "scrollDirtyRegion(self, int, int)");
...
PyDoc_STRVAR(doc_QListView_setDirtyRegion, "setDirtyRegion(self, QRegion)");
...
PyDoc_STRVAR(doc_QListView_dirtyRegionOffset, "dirtyRegionOffset(self) -> QPoint");
...
PyDoc_STRVAR(doc_QListView_viewportEvent, "viewportEvent(self, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QListView_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QListView_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QListView_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QListView_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QListView_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QListView_keyPressEvent, "keyPressEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QListView_dropIndicatorPosition, "dropIndicatorPosition(self) -> QAbstractItemView.DropIndicatorPosition");
...
PyDoc_STRVAR(doc_QListView_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QListView_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
static PyMethodDef methods_QListView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_initStyleOption), (PyCFunction)meth_QListView_initStyleOption, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_viewportMargins), (PyCFunction)meth_QListView_viewportMargins, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_wheelEvent), (PyCFunction)meth_QListView_wheelEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QListView_wheelEvent)},
...
static sipEnumMemberDef enummembers_QListView[] = {
    {sipName_Adjust, static_cast<int>( ::QListView::Adjust), 216},
    {sipName_Batched, static_cast<int>( ::QListView::Batched), 214},
    {sipName_Fixed, static_cast<int>( ::QListView::Fixed), 216},
    {sipName_Free, static_cast<int>( ::QListView::Free), 215},
    {sipName_IconMode, static_cast<int>( ::QListView::IconMode), 217},
    {sipName_LeftToRight, static_cast<int>( ::QListView::LeftToRight), 213},
    {sipName_ListMode, static_cast<int>( ::QListView::ListMode), 217},
    {sipName_SinglePass, static_cast<int>( ::QListView::SinglePass), 214},
    {sipName_Snap, static_cast<int>( ::QListView::Snap), 215},
    {sipName_Static, static_cast<int>( ::QListView::Static), 215},
    {sipName_TopToBottom, static_cast<int>( ::QListView::TopToBottom), 213},
};
