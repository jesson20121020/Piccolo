...
PyDoc_STRVAR(doc_QUndoStack_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QUndoStack_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QUndoStack_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QUndoStack_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QUndoStack_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QUndoStack_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QUndoStack_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QUndoStack_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QUndoStack_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static PyMethodDef methods_QUndoStack[] = {
    ...
    {SIP_MLNAME_CAST(sipName_resetClean), meth_QUndoStack_resetClean, METH_VARARGS, SIP_MLDOC_CAST(doc_QUndoStack_resetClean)},
