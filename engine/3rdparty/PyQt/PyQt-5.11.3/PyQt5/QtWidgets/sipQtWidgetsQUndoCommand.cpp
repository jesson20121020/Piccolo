...
PyDoc_STRVAR(doc_QUndoCommand_isObsolete, "isObsolete(self) -> bool");

extern "C" {static PyObject *meth_QUndoCommand_isObsolete(PyObject *, PyObject *);}
static PyObject *meth_QUndoCommand_isObsolete(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QUndoCommand, sipName_isObsolete, doc_QUndoCommand_isObsolete);

    return NULL;
}


PyDoc_STRVAR(doc_QUndoCommand_setObsolete, "setObsolete(self, bool)");

extern "C" {static PyObject *meth_QUndoCommand_setObsolete(PyObject *, PyObject *);}
static PyObject *meth_QUndoCommand_setObsolete(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "Bb", &sipSelf, sipType_QUndoCommand, &sipCpp, &a0))
        {
            sipCpp->setObsolete(a0);
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QUndoCommand, sipName_setObsolete, doc_QUndoCommand_setObsolete);
...
static PyMethodDef methods_QUndoCommand[] = {
    ...
    {SIP_MLNAME_CAST(sipName_isObsolete), meth_QUndoCommand_isObsolete, METH_VARARGS, SIP_MLDOC_CAST(doc_QUndoCommand_isObsolete)},
    ...
    {SIP_MLNAME_CAST(sipName_setObsolete), meth_QUndoCommand_setObsolete, METH_VARARGS, SIP_MLDOC_CAST(doc_QUndoCommand_setObsolete)},
