...
void sipQTreeView::sipProtect_initStyleOption( ::QStyleOptionFrame*a0) const
{
...
void sipQTreeView::sipProtect_setViewportMargins(const  ::QMargins& a0)
{
 ...
 ::QMargins sipQTreeView::sipProtect_viewportMargins() const
{
...
PyDoc_STRVAR(doc_QTreeView_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTreeView_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTreeView_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTreeView_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTreeView_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTreeView_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTreeView_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTreeView_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QTreeView_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTreeView_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTreeView_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QTreeView_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QTreeView_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QTreeView_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QTreeView_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QTreeView_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QTreeView_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QTreeView_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QTreeView_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QTreeView_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QTreeView_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QTreeView_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QTreeView_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QTreeView_changeEvent, "changeEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTreeView_drawFrame, "drawFrame(self, QPainter)");
...
PyDoc_STRVAR(doc_QTreeView_initStyleOption, "initStyleOption(self, QStyleOptionFrame)");

extern "C" {static PyObject *meth_QTreeView_initStyleOption(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QTreeView_initStyleOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "BJ8", &sipSelf, sipType_QTreeView, &sipCpp, sipType_QStyleOptionFrame, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QTreeView, sipName_initStyleOption, doc_QTreeView_initStyleOption);

    return NULL;
}


PyDoc_STRVAR(doc_QTreeView_setViewportMargins, "setViewportMargins(self, int, int, int, int)\n"
...
PyDoc_STRVAR(doc_QTreeView_viewportMargins, "viewportMargins(self) -> QMargins");

extern "C" {static PyObject *meth_QTreeView_viewportMargins(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QTreeView_viewportMargins(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QTreeView, sipName_viewportMargins, doc_QTreeView_viewportMargins);

    return NULL;
}


PyDoc_STRVAR(doc_QTreeView_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QTreeView_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QTreeView_eventFilter, "eventFilter(self, QObject, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_edit, "edit(self, QModelIndex)\n"
...
PyDoc_STRVAR(doc_QTreeView_updateEditorData, "updateEditorData(self)");
...
PyDoc_STRVAR(doc_QTreeView_updateEditorGeometries, "updateEditorGeometries(self)");
...
PyDoc_STRVAR(doc_QTreeView_verticalScrollbarAction, "verticalScrollbarAction(self, int)");
...
PyDoc_STRVAR(doc_QTreeView_verticalScrollbarValueChanged, "verticalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QTreeView_horizontalScrollbarValueChanged, "horizontalScrollbarValueChanged(self, int)");
...
PyDoc_STRVAR(doc_QTreeView_closeEditor, "closeEditor(self, QWidget, QAbstractItemDelegate.EndEditHint)");
...
PyDoc_STRVAR(doc_QTreeView_commitData, "commitData(self, QWidget)");
...
PyDoc_STRVAR(doc_QTreeView_editorDestroyed, "editorDestroyed(self, QObject)");
...
PyDoc_STRVAR(doc_QTreeView_selectionCommand, "selectionCommand(self, QModelIndex, event: QEvent = None) -> QItemSelectionModel.SelectionFlags");
...
PyDoc_STRVAR(doc_QTreeView_startDrag, "startDrag(self, Union[Qt.DropActions, Qt.DropAction])");
...
PyDoc_STRVAR(doc_QTreeView_viewOptions, "viewOptions(self) -> QStyleOptionViewItem");
...
PyDoc_STRVAR(doc_QTreeView_state, "state(self) -> QAbstractItemView.State");
...
PyDoc_STRVAR(doc_QTreeView_setState, "setState(self, QAbstractItemView.State)");
...
PyDoc_STRVAR(doc_QTreeView_scheduleDelayedItemsLayout, "scheduleDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QTreeView_executeDelayedItemsLayout, "executeDelayedItemsLayout(self)");
...
PyDoc_STRVAR(doc_QTreeView_scrollDirtyRegion, "scrollDirtyRegion(self, int, int)");
...
PyDoc_STRVAR(doc_QTreeView_setDirtyRegion, "setDirtyRegion(self, QRegion)");
...
PyDoc_STRVAR(doc_QTreeView_dirtyRegionOffset, "dirtyRegionOffset(self) -> QPoint");
...
PyDoc_STRVAR(doc_QTreeView_event, "event(self, QEvent) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QTreeView_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QTreeView_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QTreeView_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QTreeView_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QTreeView_resizeEvent, "resizeEvent(self, QResizeEvent)");
...
PyDoc_STRVAR(doc_QTreeView_dropIndicatorPosition, "dropIndicatorPosition(self) -> QAbstractItemView.DropIndicatorPosition");
...
PyDoc_STRVAR(doc_QTreeView_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QTreeView_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
static PyMethodDef methods_QTreeView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_initStyleOption), (PyCFunction)meth_QTreeView_initStyleOption, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_viewportMargins), (PyCFunction)meth_QTreeView_viewportMargins, METH_VARARGS|METH_KEYWORDS, NULL},
