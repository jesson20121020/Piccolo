...
PyDoc_STRVAR(doc_QGraphicsAnchorLayout_setGraphicsItem, "setGraphicsItem(self, QGraphicsItem)");
...
PyDoc_STRVAR(doc_QGraphicsAnchorLayout_setOwnedByLayout, "setOwnedByLayout(self, bool)");
...
PyDoc_STRVAR(doc_QGraphicsAnchorLayout_addChildLayoutItem, "addChildLayoutItem(self, QGraphicsLayoutItem)");
