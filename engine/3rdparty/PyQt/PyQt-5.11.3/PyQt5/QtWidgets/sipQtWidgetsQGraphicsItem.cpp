...
static sipEnumMemberDef enummembers_QGraphicsItem[] = {
    {sipName_DeviceCoordinateCache, static_cast<int>( ::QGraphicsItem::DeviceCoordinateCache), 123},
    {sipName_ItemAcceptsInputMethod, static_cast<int>( ::QGraphicsItem::ItemAcceptsInputMethod), 125},
    {sipName_ItemChildAddedChange, static_cast<int>( ::QGraphicsItem::ItemChildAddedChange), 124},
    {sipName_ItemChildRemovedChange, static_cast<int>( ::QGraphicsItem::ItemChildRemovedChange), 124},
    {sipName_ItemClipsChildrenToShape, static_cast<int>( ::QGraphicsItem::ItemClipsChildrenToShape), 125},
    {sipName_ItemClipsToShape, static_cast<int>( ::QGraphicsItem::ItemClipsToShape), 125},
    {sipName_ItemContainsChildrenInShape, static_cast<int>( ::QGraphicsItem::ItemContainsChildrenInShape), 125},
    {sipName_ItemCoordinateCache, static_cast<int>( ::QGraphicsItem::ItemCoordinateCache), 123},
    {sipName_ItemCursorChange, static_cast<int>( ::QGraphicsItem::ItemCursorChange), 124},
    {sipName_ItemCursorHasChanged, static_cast<int>( ::QGraphicsItem::ItemCursorHasChanged), 124},
    {sipName_ItemDoesntPropagateOpacityToChildren, static_cast<int>( ::QGraphicsItem::ItemDoesntPropagateOpacityToChildren), 125},
    {sipName_ItemEnabledChange, static_cast<int>( ::QGraphicsItem::ItemEnabledChange), 124},
    {sipName_ItemEnabledHasChanged, static_cast<int>( ::QGraphicsItem::ItemEnabledHasChanged), 124},
    {sipName_ItemFlagsChange, static_cast<int>( ::QGraphicsItem::ItemFlagsChange), 124},
    {sipName_ItemFlagsHaveChanged, static_cast<int>( ::QGraphicsItem::ItemFlagsHaveChanged), 124},
    {sipName_ItemHasNoContents, static_cast<int>( ::QGraphicsItem::ItemHasNoContents), 125},
    {sipName_ItemIgnoresParentOpacity, static_cast<int>( ::QGraphicsItem::ItemIgnoresParentOpacity), 125},
    {sipName_ItemIgnoresTransformations, static_cast<int>( ::QGraphicsItem::ItemIgnoresTransformations), 125},
    {sipName_ItemIsFocusable, static_cast<int>( ::QGraphicsItem::ItemIsFocusable), 125},
    {sipName_ItemIsMovable, static_cast<int>( ::QGraphicsItem::ItemIsMovable), 125},
    {sipName_ItemIsPanel, static_cast<int>( ::QGraphicsItem::ItemIsPanel), 125},
    {sipName_ItemIsSelectable, static_cast<int>( ::QGraphicsItem::ItemIsSelectable), 125},
    {sipName_ItemMatrixChange, static_cast<int>( ::QGraphicsItem::ItemMatrixChange), 124},
    {sipName_ItemNegativeZStacksBehindParent, static_cast<int>( ::QGraphicsItem::ItemNegativeZStacksBehindParent), 125},
    {sipName_ItemOpacityChange, static_cast<int>( ::QGraphicsItem::ItemOpacityChange), 124},
    {sipName_ItemOpacityHasChanged, static_cast<int>( ::QGraphicsItem::ItemOpacityHasChanged), 124},
    {sipName_ItemParentChange, static_cast<int>( ::QGraphicsItem::ItemParentChange), 124},
    {sipName_ItemParentHasChanged, static_cast<int>( ::QGraphicsItem::ItemParentHasChanged), 124},
    {sipName_ItemPositionChange, static_cast<int>( ::QGraphicsItem::ItemPositionChange), 124},
    {sipName_ItemPositionHasChanged, static_cast<int>( ::QGraphicsItem::ItemPositionHasChanged), 124},
    {sipName_ItemRotationChange, static_cast<int>( ::QGraphicsItem::ItemRotationChange), 124},
    {sipName_ItemRotationHasChanged, static_cast<int>( ::QGraphicsItem::ItemRotationHasChanged), 124},
    {sipName_ItemScaleChange, static_cast<int>( ::QGraphicsItem::ItemScaleChange), 124},
    {sipName_ItemScaleHasChanged, static_cast<int>( ::QGraphicsItem::ItemScaleHasChanged), 124},
    {sipName_ItemSceneChange, static_cast<int>( ::QGraphicsItem::ItemSceneChange), 124},
    {sipName_ItemSceneHasChanged, static_cast<int>( ::QGraphicsItem::ItemSceneHasChanged), 124},
    {sipName_ItemScenePositionHasChanged, static_cast<int>( ::QGraphicsItem::ItemScenePositionHasChanged), 124},
    {sipName_ItemSelectedChange, static_cast<int>( ::QGraphicsItem::ItemSelectedChange), 124},
    {sipName_ItemSelectedHasChanged, static_cast<int>( ::QGraphicsItem::ItemSelectedHasChanged), 124},
    {sipName_ItemSendsGeometryChanges, static_cast<int>( ::QGraphicsItem::ItemSendsGeometryChanges), 125},
    {sipName_ItemSendsScenePositionChanges, static_cast<int>( ::QGraphicsItem::ItemSendsScenePositionChanges), 125},
    {sipName_ItemStacksBehindParent, static_cast<int>( ::QGraphicsItem::ItemStacksBehindParent), 125},
    {sipName_ItemToolTipChange, static_cast<int>( ::QGraphicsItem::ItemToolTipChange), 124},
    {sipName_ItemToolTipHasChanged, static_cast<int>( ::QGraphicsItem::ItemToolTipHasChanged), 124},
    {sipName_ItemTransformChange, static_cast<int>( ::QGraphicsItem::ItemTransformChange), 124},
    {sipName_ItemTransformHasChanged, static_cast<int>( ::QGraphicsItem::ItemTransformHasChanged), 124},
    {sipName_ItemTransformOriginPointChange, static_cast<int>( ::QGraphicsItem::ItemTransformOriginPointChange), 124},
    {sipName_ItemTransformOriginPointHasChanged, static_cast<int>( ::QGraphicsItem::ItemTransformOriginPointHasChanged), 124},
    {sipName_ItemUsesExtendedStyleOption, static_cast<int>( ::QGraphicsItem::ItemUsesExtendedStyleOption), 125},
    {sipName_ItemVisibleChange, static_cast<int>( ::QGraphicsItem::ItemVisibleChange), 124},
    {sipName_ItemVisibleHasChanged, static_cast<int>( ::QGraphicsItem::ItemVisibleHasChanged), 124},
    {sipName_ItemZValueChange, static_cast<int>( ::QGraphicsItem::ItemZValueChange), 124},
    {sipName_ItemZValueHasChanged, static_cast<int>( ::QGraphicsItem::ItemZValueHasChanged), 124},
    {sipName_NoCache, static_cast<int>( ::QGraphicsItem::NoCache), 123},
    {sipName_NonModal, static_cast<int>( ::QGraphicsItem::NonModal), 127},
    {sipName_PanelModal, static_cast<int>( ::QGraphicsItem::PanelModal), 127},
    {sipName_SceneModal, static_cast<int>( ::QGraphicsItem::SceneModal), 127},
};
