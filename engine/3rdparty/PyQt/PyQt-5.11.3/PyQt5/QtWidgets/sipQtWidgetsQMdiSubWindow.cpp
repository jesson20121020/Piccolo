...
PyDoc_STRVAR(doc_QMdiSubWindow_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QMdiSubWindow_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QMdiSubWindow_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QMdiSubWindow_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QMdiSubWindow_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QMdiSubWindow_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QMdiSubWindow_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QMdiSubWindow_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMdiSubWindow_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QMdiSubWindow_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QMdiSubWindow_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QMdiSubWindow_initPainter, "initPainter(self, QPainter)");
