...
void sipQSplitter::sipProtect_initStyleOption( ::QStyleOptionFrame*a0) const
{
...
PyDoc_STRVAR(doc_QSplitter_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QSplitter_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QSplitter_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QSplitter_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSplitter_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSplitter_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSplitter_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QSplitter_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QSplitter_mousePressEvent, "mousePressEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QSplitter_mouseReleaseEvent, "mouseReleaseEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QSplitter_mouseDoubleClickEvent, "mouseDoubleClickEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QSplitter_mouseMoveEvent, "mouseMoveEvent(self, QMouseEvent)");
...
PyDoc_STRVAR(doc_QSplitter_wheelEvent, "wheelEvent(self, QWheelEvent)");
...
PyDoc_STRVAR(doc_QSplitter_keyPressEvent, "keyPressEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QSplitter_keyReleaseEvent, "keyReleaseEvent(self, QKeyEvent)");
...
PyDoc_STRVAR(doc_QSplitter_focusInEvent, "focusInEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QSplitter_focusOutEvent, "focusOutEvent(self, QFocusEvent)");
...
PyDoc_STRVAR(doc_QSplitter_enterEvent, "enterEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSplitter_leaveEvent, "leaveEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSplitter_moveEvent, "moveEvent(self, QMoveEvent)");
...
PyDoc_STRVAR(doc_QSplitter_closeEvent, "closeEvent(self, QCloseEvent)");
...
PyDoc_STRVAR(doc_QSplitter_contextMenuEvent, "contextMenuEvent(self, QContextMenuEvent)");
...
PyDoc_STRVAR(doc_QSplitter_tabletEvent, "tabletEvent(self, QTabletEvent)");
...
PyDoc_STRVAR(doc_QSplitter_actionEvent, "actionEvent(self, QActionEvent)");
...
PyDoc_STRVAR(doc_QSplitter_dragEnterEvent, "dragEnterEvent(self, QDragEnterEvent)");
...
PyDoc_STRVAR(doc_QSplitter_dragMoveEvent, "dragMoveEvent(self, QDragMoveEvent)");
...
PyDoc_STRVAR(doc_QSplitter_dragLeaveEvent, "dragLeaveEvent(self, QDragLeaveEvent)");
...
PyDoc_STRVAR(doc_QSplitter_dropEvent, "dropEvent(self, QDropEvent)");
...
PyDoc_STRVAR(doc_QSplitter_showEvent, "showEvent(self, QShowEvent)");
...
PyDoc_STRVAR(doc_QSplitter_hideEvent, "hideEvent(self, QHideEvent)");
...
PyDoc_STRVAR(doc_QSplitter_metric, "metric(self, QPaintDevice.PaintDeviceMetric) -> int");
...
PyDoc_STRVAR(doc_QSplitter_inputMethodEvent, "inputMethodEvent(self, QInputMethodEvent)");
...
PyDoc_STRVAR(doc_QSplitter_updateMicroFocus, "updateMicroFocus(self)");
...
PyDoc_STRVAR(doc_QSplitter_create, "create(self, window: sip.voidptr = 0, initializeWindow: bool = True, destroyOldWindow: bool = True)");
...
PyDoc_STRVAR(doc_QSplitter_destroy, "destroy(self, destroyWindow: bool = True, destroySubWindows: bool = True)");
...
PyDoc_STRVAR(doc_QSplitter_focusNextPrevChild, "focusNextPrevChild(self, bool) -> bool");
...
PyDoc_STRVAR(doc_QSplitter_focusNextChild, "focusNextChild(self) -> bool");
...
PyDoc_STRVAR(doc_QSplitter_focusPreviousChild, "focusPreviousChild(self) -> bool");
...
PyDoc_STRVAR(doc_QSplitter_nativeEvent, "nativeEvent(self, Union[QByteArray, bytes, bytearray], sip.voidptr) -> Tuple[bool, int]");
...
PyDoc_STRVAR(doc_QSplitter_sharedPainter, "sharedPainter(self) -> QPainter");
...
PyDoc_STRVAR(doc_QSplitter_initPainter, "initPainter(self, QPainter)");
...
PyDoc_STRVAR(doc_QSplitter_paintEvent, "paintEvent(self, QPaintEvent)");
...
PyDoc_STRVAR(doc_QSplitter_drawFrame, "drawFrame(self, QPainter)");
...
PyDoc_STRVAR(doc_QSplitter_initStyleOption, "initStyleOption(self, QStyleOptionFrame)");

extern "C" {static PyObject *meth_QSplitter_initStyleOption(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_QSplitter_initStyleOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "BJ8", &sipSelf, sipType_QSplitter, &sipCpp, sipType_QStyleOptionFrame, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QSplitter, sipName_initStyleOption, doc_QSplitter_initStyleOption);
...
static sipEncodedTypeDef supers_QSplitter[] = {{99, 255, 1}};
...
static PyMethodDef methods_QSplitter[] = {
    ...
    {SIP_MLNAME_CAST(sipName_initStyleOption), (PyCFunction)meth_QSplitter_initStyleOption, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_replaceWidget), meth_QSplitter_replaceWidget, METH_VARARGS, SIP_MLDOC_CAST(doc_QSplitter_replaceWidget)},
