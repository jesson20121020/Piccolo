...
PyDoc_STRVAR(doc_QSignalMapper_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QSignalMapper_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QSignalMapper_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QSignalMapper_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QSignalMapper_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSignalMapper_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSignalMapper_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSignalMapper_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QSignalMapper_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QSignalMapper[] = {{172, 255, 1}};
