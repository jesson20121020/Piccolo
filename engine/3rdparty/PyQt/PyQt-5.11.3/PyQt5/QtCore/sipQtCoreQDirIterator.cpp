...
static sipEnumMemberDef enummembers_QDirIterator[] = {
    {sipName_FollowSymlinks, static_cast<int>( ::QDirIterator::FollowSymlinks), 52},
    {sipName_NoIteratorFlags, static_cast<int>( ::QDirIterator::NoIteratorFlags), 52},
    {sipName_Subdirectories, static_cast<int>( ::QDirIterator::Subdirectories), 52},
};
