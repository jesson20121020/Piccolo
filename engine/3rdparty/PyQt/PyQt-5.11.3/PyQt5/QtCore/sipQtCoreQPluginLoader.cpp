...
PyDoc_STRVAR(doc_QPluginLoader_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QPluginLoader_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QPluginLoader_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QPluginLoader_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QPluginLoader_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QPluginLoader_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPluginLoader_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPluginLoader_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QPluginLoader_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QPluginLoader[] = {{172, 255, 1}};
