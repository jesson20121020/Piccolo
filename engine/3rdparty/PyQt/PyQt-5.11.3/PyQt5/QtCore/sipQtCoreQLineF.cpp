...
static sipEnumMemberDef enummembers_QLineF[] = {
    {sipName_BoundedIntersection, static_cast<int>( ::QLineF::BoundedIntersection), 110},
    {sipName_NoIntersection, static_cast<int>( ::QLineF::NoIntersection), 110},
    {sipName_UnboundedIntersection, static_cast<int>( ::QLineF::UnboundedIntersection), 110},
};
