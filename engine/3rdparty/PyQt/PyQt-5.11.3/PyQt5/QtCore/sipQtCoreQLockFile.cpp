...
static sipEnumMemberDef enummembers_QLockFile[] = {
    {sipName_LockFailedError, static_cast<int>( ::QLockFile::LockFailedError), 145},
    {sipName_NoError, static_cast<int>( ::QLockFile::NoError), 145},
    {sipName_PermissionError, static_cast<int>( ::QLockFile::PermissionError), 145},
    {sipName_UnknownError, static_cast<int>( ::QLockFile::UnknownError), 145},
};
