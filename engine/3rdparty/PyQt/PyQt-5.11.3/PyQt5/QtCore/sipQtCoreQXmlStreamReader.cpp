...
static sipEnumMemberDef enummembers_QXmlStreamReader[] = {
    {sipName_Characters, static_cast<int>( ::QXmlStreamReader::Characters), 325},
    {sipName_Comment, static_cast<int>( ::QXmlStreamReader::Comment), 325},
    {sipName_CustomError, static_cast<int>( ::QXmlStreamReader::CustomError), 323},
    {sipName_DTD, static_cast<int>( ::QXmlStreamReader::DTD), 325},
    {sipName_EndDocument, static_cast<int>( ::QXmlStreamReader::EndDocument), 325},
    {sipName_EndElement, static_cast<int>( ::QXmlStreamReader::EndElement), 325},
    {sipName_EntityReference, static_cast<int>( ::QXmlStreamReader::EntityReference), 325},
    {sipName_ErrorOnUnexpectedElement, static_cast<int>( ::QXmlStreamReader::ErrorOnUnexpectedElement), 324},
    {sipName_IncludeChildElements, static_cast<int>( ::QXmlStreamReader::IncludeChildElements), 324},
    {sipName_Invalid, static_cast<int>( ::QXmlStreamReader::Invalid), 325},
    {sipName_NoError, static_cast<int>( ::QXmlStreamReader::NoError), 323},
    {sipName_NoToken, static_cast<int>( ::QXmlStreamReader::NoToken), 325},
    {sipName_NotWellFormedError, static_cast<int>( ::QXmlStreamReader::NotWellFormedError), 323},
    {sipName_PrematureEndOfDocumentError, static_cast<int>( ::QXmlStreamReader::PrematureEndOfDocumentError), 323},
    {sipName_ProcessingInstruction, static_cast<int>( ::QXmlStreamReader::ProcessingInstruction), 325},
    {sipName_SkipChildElements, static_cast<int>( ::QXmlStreamReader::SkipChildElements), 324},
    {sipName_StartDocument, static_cast<int>( ::QXmlStreamReader::StartDocument), 325},
    {sipName_StartElement, static_cast<int>( ::QXmlStreamReader::StartElement), 325},
    {sipName_UnexpectedElementError, static_cast<int>( ::QXmlStreamReader::UnexpectedElementError), 323},
};
