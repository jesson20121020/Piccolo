...
static sipEnumMemberDef enummembers_QTextStream[] = {
    {sipName_AlignAccountingStyle, static_cast<int>( ::QTextStream::AlignAccountingStyle), 268},
    {sipName_AlignCenter, static_cast<int>( ::QTextStream::AlignCenter), 268},
    {sipName_AlignLeft, static_cast<int>( ::QTextStream::AlignLeft), 268},
    {sipName_AlignRight, static_cast<int>( ::QTextStream::AlignRight), 268},
    {sipName_FixedNotation, static_cast<int>( ::QTextStream::FixedNotation), 271},
    {sipName_ForcePoint, static_cast<int>( ::QTextStream::ForcePoint), 269},
    {sipName_ForceSign, static_cast<int>( ::QTextStream::ForceSign), 269},
    {sipName_Ok, static_cast<int>( ::QTextStream::Ok), 272},
    {sipName_ReadCorruptData, static_cast<int>( ::QTextStream::ReadCorruptData), 272},
    {sipName_ReadPastEnd, static_cast<int>( ::QTextStream::ReadPastEnd), 272},
    {sipName_ScientificNotation, static_cast<int>( ::QTextStream::ScientificNotation), 271},
    {sipName_ShowBase, static_cast<int>( ::QTextStream::ShowBase), 269},
    {sipName_SmartNotation, static_cast<int>( ::QTextStream::SmartNotation), 271},
    {sipName_UppercaseBase, static_cast<int>( ::QTextStream::UppercaseBase), 269},
    {sipName_UppercaseDigits, static_cast<int>( ::QTextStream::UppercaseDigits), 269},
    {sipName_WriteFailed, static_cast<int>( ::QTextStream::WriteFailed), 272},
};
