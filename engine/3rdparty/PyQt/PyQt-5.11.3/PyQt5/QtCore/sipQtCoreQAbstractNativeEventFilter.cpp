...
bool sipQAbstractNativeEventFilter::nativeEventFilter(const  ::QByteArray& a0,void*a1,long*a2)
{
    ...
    extern bool sipVH_QtCore_43(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::QByteArray&,void*,long*);

    return sipVH_QtCore_43(sipGILState, sipVEH_QtCore_PyQt5, sipPySelf, sipMeth, a0, a1, a2);
}
