...
static PyObject *slot_QJsonValue___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QJsonValue, sipName___getitem__, NULL);
...
static sipEnumMemberDef enummembers_QJsonValue[] = {
    {sipName_Array, static_cast<int>( ::QJsonValue::Array), 102},
    {sipName_Bool, static_cast<int>( ::QJsonValue::Bool), 102},
    {sipName_Double, static_cast<int>( ::QJsonValue::Double), 102},
    {sipName_Null, static_cast<int>( ::QJsonValue::Null), 102},
    {sipName_Object, static_cast<int>( ::QJsonValue::Object), 102},
    {sipName_String, static_cast<int>( ::QJsonValue::String), 102},
    {sipName_Undefined, static_cast<int>( ::QJsonValue::Undefined), 102},
};
