...
static sipEnumMemberDef enummembers_QUuid[] = {
    {sipName_DCE, static_cast<int>( ::QUuid::DCE), 299},
    {sipName_EmbeddedPOSIX, static_cast<int>( ::QUuid::EmbeddedPOSIX), 300},
    {sipName_Md5, static_cast<int>( ::QUuid::Md5), 300},
    {sipName_Microsoft, static_cast<int>( ::QUuid::Microsoft), 299},
    {sipName_NCS, static_cast<int>( ::QUuid::NCS), 299},
    {sipName_Name, static_cast<int>( ::QUuid::Name), 300},
    {sipName_Random, static_cast<int>( ::QUuid::Random), 300},
    {sipName_Reserved, static_cast<int>( ::QUuid::Reserved), 299},
    {sipName_Sha1, static_cast<int>( ::QUuid::Sha1), 300},
    {sipName_Time, static_cast<int>( ::QUuid::Time), 300},
    {sipName_VarUnknown, static_cast<int>( ::QUuid::VarUnknown), 299},
    {sipName_VerUnknown, static_cast<int>( ::QUuid::VerUnknown), 300},
};
