...
static sipEnumMemberDef enummembers_QEasingCurve[] = {
    {sipName_BezierSpline, static_cast<int>( ::QEasingCurve::BezierSpline), 56},
    {sipName_CosineCurve, static_cast<int>( ::QEasingCurve::CosineCurve), 56},
    {sipName_Custom, static_cast<int>( ::QEasingCurve::Custom), 56},
    {sipName_InBack, static_cast<int>( ::QEasingCurve::InBack), 56},
    {sipName_InBounce, static_cast<int>( ::QEasingCurve::InBounce), 56},
    {sipName_InCirc, static_cast<int>( ::QEasingCurve::InCirc), 56},
    {sipName_InCubic, static_cast<int>( ::QEasingCurve::InCubic), 56},
    {sipName_InCurve, static_cast<int>( ::QEasingCurve::InCurve), 56},
    {sipName_InElastic, static_cast<int>( ::QEasingCurve::InElastic), 56},
    {sipName_InExpo, static_cast<int>( ::QEasingCurve::InExpo), 56},
    {sipName_InOutBack, static_cast<int>( ::QEasingCurve::InOutBack), 56},
    {sipName_InOutBounce, static_cast<int>( ::QEasingCurve::InOutBounce), 56},
    {sipName_InOutCirc, static_cast<int>( ::QEasingCurve::InOutCirc), 56},
    {sipName_InOutCubic, static_cast<int>( ::QEasingCurve::InOutCubic), 56},
    {sipName_InOutElastic, static_cast<int>( ::QEasingCurve::InOutElastic), 56},
    {sipName_InOutExpo, static_cast<int>( ::QEasingCurve::InOutExpo), 56},
    {sipName_InOutQuad, static_cast<int>( ::QEasingCurve::InOutQuad), 56},
    {sipName_InOutQuart, static_cast<int>( ::QEasingCurve::InOutQuart), 56},
    {sipName_InOutQuint, static_cast<int>( ::QEasingCurve::InOutQuint), 56},
    {sipName_InOutSine, static_cast<int>( ::QEasingCurve::InOutSine), 56},
    {sipName_InQuad, static_cast<int>( ::QEasingCurve::InQuad), 56},
    {sipName_InQuart, static_cast<int>( ::QEasingCurve::InQuart), 56},
    {sipName_InQuint, static_cast<int>( ::QEasingCurve::InQuint), 56},
    {sipName_InSine, static_cast<int>( ::QEasingCurve::InSine), 56},
    {sipName_Linear, static_cast<int>( ::QEasingCurve::Linear), 56},
    {sipName_OutBack, static_cast<int>( ::QEasingCurve::OutBack), 56},
    {sipName_OutBounce, static_cast<int>( ::QEasingCurve::OutBounce), 56},
    {sipName_OutCirc, static_cast<int>( ::QEasingCurve::OutCirc), 56},
    {sipName_OutCubic, static_cast<int>( ::QEasingCurve::OutCubic), 56},
    {sipName_OutCurve, static_cast<int>( ::QEasingCurve::OutCurve), 56},
    {sipName_OutElastic, static_cast<int>( ::QEasingCurve::OutElastic), 56},
    {sipName_OutExpo, static_cast<int>( ::QEasingCurve::OutExpo), 56},
    {sipName_OutInBack, static_cast<int>( ::QEasingCurve::OutInBack), 56},
    {sipName_OutInBounce, static_cast<int>( ::QEasingCurve::OutInBounce), 56},
    {sipName_OutInCirc, static_cast<int>( ::QEasingCurve::OutInCirc), 56},
    {sipName_OutInCubic, static_cast<int>( ::QEasingCurve::OutInCubic), 56},
    {sipName_OutInElastic, static_cast<int>( ::QEasingCurve::OutInElastic), 56},
    {sipName_OutInExpo, static_cast<int>( ::QEasingCurve::OutInExpo), 56},
    {sipName_OutInQuad, static_cast<int>( ::QEasingCurve::OutInQuad), 56},
    {sipName_OutInQuart, static_cast<int>( ::QEasingCurve::OutInQuart), 56},
    {sipName_OutInQuint, static_cast<int>( ::QEasingCurve::OutInQuint), 56},
    {sipName_OutInSine, static_cast<int>( ::QEasingCurve::OutInSine), 56},
    {sipName_OutQuad, static_cast<int>( ::QEasingCurve::OutQuad), 56},
    {sipName_OutQuart, static_cast<int>( ::QEasingCurve::OutQuart), 56},
    {sipName_OutQuint, static_cast<int>( ::QEasingCurve::OutQuint), 56},
    {sipName_OutSine, static_cast<int>( ::QEasingCurve::OutSine), 56},
    {sipName_SineCurve, static_cast<int>( ::QEasingCurve::SineCurve), 56},
    {sipName_TCBSpline, static_cast<int>( ::QEasingCurve::TCBSpline), 56},
};
