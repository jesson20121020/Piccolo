...
static sipEnumMemberDef enummembers_QLibraryInfo[] = {
    {sipName_ArchDataPath, static_cast<int>( ::QLibraryInfo::ArchDataPath), 107},
    {sipName_BinariesPath, static_cast<int>( ::QLibraryInfo::BinariesPath), 107},
    {sipName_DataPath, static_cast<int>( ::QLibraryInfo::DataPath), 107},
    {sipName_DocumentationPath, static_cast<int>( ::QLibraryInfo::DocumentationPath), 107},
    {sipName_ExamplesPath, static_cast<int>( ::QLibraryInfo::ExamplesPath), 107},
    {sipName_HeadersPath, static_cast<int>( ::QLibraryInfo::HeadersPath), 107},
    {sipName_ImportsPath, static_cast<int>( ::QLibraryInfo::ImportsPath), 107},
    {sipName_LibrariesPath, static_cast<int>( ::QLibraryInfo::LibrariesPath), 107},
    {sipName_LibraryExecutablesPath, static_cast<int>( ::QLibraryInfo::LibraryExecutablesPath), 107},
    {sipName_PluginsPath, static_cast<int>( ::QLibraryInfo::PluginsPath), 107},
    {sipName_PrefixPath, static_cast<int>( ::QLibraryInfo::PrefixPath), 107},
    {sipName_Qml2ImportsPath, static_cast<int>( ::QLibraryInfo::Qml2ImportsPath), 107},
    {sipName_SettingsPath, static_cast<int>( ::QLibraryInfo::SettingsPath), 107},
    {sipName_TestsPath, static_cast<int>( ::QLibraryInfo::TestsPath), 107},
    {sipName_TranslationsPath, static_cast<int>( ::QLibraryInfo::TranslationsPath), 107},
};
