...
static sipEnumMemberDef enummembers_QJsonParseError[] = {
    {sipName_DeepNesting, static_cast<int>( ::QJsonParseError::DeepNesting), 100},
    {sipName_DocumentTooLarge, static_cast<int>( ::QJsonParseError::DocumentTooLarge), 100},
    {sipName_GarbageAtEnd, static_cast<int>( ::QJsonParseError::GarbageAtEnd), 100},
    {sipName_IllegalEscapeSequence, static_cast<int>( ::QJsonParseError::IllegalEscapeSequence), 100},
    {sipName_IllegalNumber, static_cast<int>( ::QJsonParseError::IllegalNumber), 100},
    {sipName_IllegalUTF8String, static_cast<int>( ::QJsonParseError::IllegalUTF8String), 100},
    {sipName_IllegalValue, static_cast<int>( ::QJsonParseError::IllegalValue), 100},
    {sipName_MissingNameSeparator, static_cast<int>( ::QJsonParseError::MissingNameSeparator), 100},
    {sipName_MissingObject, static_cast<int>( ::QJsonParseError::MissingObject), 100},
    {sipName_MissingValueSeparator, static_cast<int>( ::QJsonParseError::MissingValueSeparator), 100},
    {sipName_NoError, static_cast<int>( ::QJsonParseError::NoError), 100},
    {sipName_TerminationByNumber, static_cast<int>( ::QJsonParseError::TerminationByNumber), 100},
    {sipName_UnterminatedArray, static_cast<int>( ::QJsonParseError::UnterminatedArray), 100},
    {sipName_UnterminatedObject, static_cast<int>( ::QJsonParseError::UnterminatedObject), 100},
    {sipName_UnterminatedString, static_cast<int>( ::QJsonParseError::UnterminatedString), 100},
};
