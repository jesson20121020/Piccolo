...
static sipEnumMemberDef enummembers_QMimeDatabase[] = {
    {sipName_MatchContent, static_cast<int>( ::QMimeDatabase::MatchContent), 166},
    {sipName_MatchDefault, static_cast<int>( ::QMimeDatabase::MatchDefault), 166},
    {sipName_MatchExtension, static_cast<int>( ::QMimeDatabase::MatchExtension), 166},
};
