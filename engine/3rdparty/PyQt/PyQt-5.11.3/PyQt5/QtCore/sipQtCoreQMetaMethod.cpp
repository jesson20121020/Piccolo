...
static sipEnumMemberDef enummembers_QMetaMethod[] = {
    {sipName_Constructor, static_cast<int>( ::QMetaMethod::Constructor), 157},
    {sipName_Method, static_cast<int>( ::QMetaMethod::Method), 157},
    {sipName_Private, static_cast<int>( ::QMetaMethod::Private), 156},
    {sipName_Protected, static_cast<int>( ::QMetaMethod::Protected), 156},
    {sipName_Public, static_cast<int>( ::QMetaMethod::Public), 156},
    {sipName_Signal, static_cast<int>( ::QMetaMethod::Signal), 157},
    {sipName_Slot, static_cast<int>( ::QMetaMethod::Slot), 157},
};
