...
static sipEnumMemberDef enummembers_QSystemSemaphore[] = {
    {sipName_AlreadyExists, static_cast<int>( ::QSystemSemaphore::AlreadyExists), 254},
    {sipName_Create, static_cast<int>( ::QSystemSemaphore::Create), 253},
    {sipName_KeyError, static_cast<int>( ::QSystemSemaphore::KeyError), 254},
    {sipName_NoError, static_cast<int>( ::QSystemSemaphore::NoError), 254},
    {sipName_NotFound, static_cast<int>( ::QSystemSemaphore::NotFound), 254},
    {sipName_Open, static_cast<int>( ::QSystemSemaphore::Open), 253},
    {sipName_OutOfResources, static_cast<int>( ::QSystemSemaphore::OutOfResources), 254},
    {sipName_PermissionDenied, static_cast<int>( ::QSystemSemaphore::PermissionDenied), 254},
    {sipName_UnknownError, static_cast<int>( ::QSystemSemaphore::UnknownError), 254},
};
