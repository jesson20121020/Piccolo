...
PyDoc_STRVAR(doc_QCoreApplication_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QCoreApplication_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QCoreApplication_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QCoreApplication_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QCoreApplication_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QCoreApplication_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QCoreApplication_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QCoreApplication_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QCoreApplication_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QCoreApplication[] = {{172, 255, 1}};
