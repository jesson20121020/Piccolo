...
static sipEnumMemberDef enummembers_QTextBoundaryFinder[] = {
    {sipName_BreakOpportunity, static_cast<int>( ::QTextBoundaryFinder::BreakOpportunity), 258},
    {sipName_EndOfItem, static_cast<int>( ::QTextBoundaryFinder::EndOfItem), 258},
    {sipName_Grapheme, static_cast<int>( ::QTextBoundaryFinder::Grapheme), 260},
    {sipName_Line, static_cast<int>( ::QTextBoundaryFinder::Line), 260},
    {sipName_MandatoryBreak, static_cast<int>( ::QTextBoundaryFinder::MandatoryBreak), 258},
    {sipName_NotAtBoundary, static_cast<int>( ::QTextBoundaryFinder::NotAtBoundary), 258},
    {sipName_Sentence, static_cast<int>( ::QTextBoundaryFinder::Sentence), 260},
    {sipName_SoftHyphen, static_cast<int>( ::QTextBoundaryFinder::SoftHyphen), 258},
    {sipName_StartOfItem, static_cast<int>( ::QTextBoundaryFinder::StartOfItem), 258},
    {sipName_Word, static_cast<int>( ::QTextBoundaryFinder::Word), 260},
};
