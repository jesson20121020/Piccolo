...
static PyObject *slot_QJsonDocument___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QJsonDocument, sipName___getitem__, NULL);
...
static sipEnumMemberDef enummembers_QJsonDocument[] = {
    {sipName_BypassValidation, static_cast<int>( ::QJsonDocument::BypassValidation), 96},
    {sipName_Compact, static_cast<int>( ::QJsonDocument::Compact), 97},
    {sipName_Indented, static_cast<int>( ::QJsonDocument::Indented), 97},
    {sipName_Validate, static_cast<int>( ::QJsonDocument::Validate), 96},
};
