...
static sipEnumMemberDef enummembers_QCommandLineOption[] = {
    {sipName_HiddenFromHelp, static_cast<int>( ::QCommandLineOption::HiddenFromHelp), 28},
    {sipName_ShortOptionStyle, static_cast<int>( ::QCommandLineOption::ShortOptionStyle), 28},
};
