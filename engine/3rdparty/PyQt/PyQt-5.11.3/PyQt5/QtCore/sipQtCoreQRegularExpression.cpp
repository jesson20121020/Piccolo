...
static sipEnumMemberDef enummembers_QRegularExpression[] = {
    {sipName_AnchoredMatchOption, static_cast<int>( ::QRegularExpression::AnchoredMatchOption), 202},
    {sipName_CaseInsensitiveOption, static_cast<int>( ::QRegularExpression::CaseInsensitiveOption), 205},
    {sipName_DontAutomaticallyOptimizeOption, static_cast<int>( ::QRegularExpression::DontAutomaticallyOptimizeOption), 205},
    {sipName_DontCaptureOption, static_cast<int>( ::QRegularExpression::DontCaptureOption), 205},
    {sipName_DontCheckSubjectStringMatchOption, static_cast<int>( ::QRegularExpression::DontCheckSubjectStringMatchOption), 202},
    {sipName_DotMatchesEverythingOption, static_cast<int>( ::QRegularExpression::DotMatchesEverythingOption), 205},
    {sipName_ExtendedPatternSyntaxOption, static_cast<int>( ::QRegularExpression::ExtendedPatternSyntaxOption), 205},
    {sipName_InvertedGreedinessOption, static_cast<int>( ::QRegularExpression::InvertedGreedinessOption), 205},
    {sipName_MultilineOption, static_cast<int>( ::QRegularExpression::MultilineOption), 205},
    {sipName_NoMatch, static_cast<int>( ::QRegularExpression::NoMatch), 204},
    {sipName_NoMatchOption, static_cast<int>( ::QRegularExpression::NoMatchOption), 202},
    {sipName_NoPatternOption, static_cast<int>( ::QRegularExpression::NoPatternOption), 205},
    {sipName_NormalMatch, static_cast<int>( ::QRegularExpression::NormalMatch), 204},
    {sipName_OptimizeOnFirstUsageOption, static_cast<int>( ::QRegularExpression::OptimizeOnFirstUsageOption), 205},
    {sipName_PartialPreferCompleteMatch, static_cast<int>( ::QRegularExpression::PartialPreferCompleteMatch), 204},
    {sipName_PartialPreferFirstMatch, static_cast<int>( ::QRegularExpression::PartialPreferFirstMatch), 204},
    {sipName_UseUnicodePropertiesOption, static_cast<int>( ::QRegularExpression::UseUnicodePropertiesOption), 205},
};
