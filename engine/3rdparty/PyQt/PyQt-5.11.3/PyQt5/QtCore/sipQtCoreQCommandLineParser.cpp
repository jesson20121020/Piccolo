...
static sipEnumMemberDef enummembers_QCommandLineParser[] = {
    {sipName_ParseAsCompactedShortOptions, static_cast<int>( ::QCommandLineParser::ParseAsCompactedShortOptions), 32},
    {sipName_ParseAsLongOptions, static_cast<int>( ::QCommandLineParser::ParseAsLongOptions), 32},
    {sipName_ParseAsOptions, static_cast<int>( ::QCommandLineParser::ParseAsOptions), 31},
    {sipName_ParseAsPositionalArguments, static_cast<int>( ::QCommandLineParser::ParseAsPositionalArguments), 31},
};
