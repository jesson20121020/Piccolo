...
PyDoc_STRVAR(doc_QSocketNotifier_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QSocketNotifier_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QSocketNotifier_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QSocketNotifier_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QSocketNotifier_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSocketNotifier_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSocketNotifier_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSocketNotifier_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QSocketNotifier_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QSocketNotifier[] = {{172, 255, 1}};
...
static sipEnumMemberDef enummembers_QSocketNotifier[] = {
    {sipName_Exception, static_cast<int>( ::QSocketNotifier::Exception), 229},
    {sipName_Read, static_cast<int>( ::QSocketNotifier::Read), 229},
    {sipName_Write, static_cast<int>( ::QSocketNotifier::Write), 229},
};
