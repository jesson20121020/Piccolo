...
static sipEnumMemberDef enummembers_QTimeZone[] = {
    {sipName_DaylightTime, static_cast<int>( ::QTimeZone::DaylightTime), 285},
    {sipName_DefaultName, static_cast<int>( ::QTimeZone::DefaultName), 283},
    {sipName_GenericTime, static_cast<int>( ::QTimeZone::GenericTime), 285},
    {sipName_LongName, static_cast<int>( ::QTimeZone::LongName), 283},
    {sipName_OffsetName, static_cast<int>( ::QTimeZone::OffsetName), 283},
    {sipName_ShortName, static_cast<int>( ::QTimeZone::ShortName), 283},
    {sipName_StandardTime, static_cast<int>( ::QTimeZone::StandardTime), 285},
};
