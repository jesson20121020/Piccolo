...
PyDoc_STRVAR(doc_QSignalTransition_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QSignalTransition_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QSignalTransition_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QSignalTransition_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QSignalTransition_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QSignalTransition_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSignalTransition_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QSignalTransition_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QSignalTransition_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
