 ...
 ::QString sipQTranslator::translate(const char*a0,const char*a1,const char*a2,int a3) const
{
    ...
    extern  ::QString sipVH_QtCore_67(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const char*,const char*,const char*,int);

    return sipVH_QtCore_67(sipGILState, sipVEH_QtCore_PyQt5, sipPySelf, sipMeth, a0, a1, a2, a3);
}
...
PyDoc_STRVAR(doc_QTranslator_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTranslator_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTranslator_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QTranslator_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTranslator_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTranslator_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTranslator_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTranslator_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTranslator_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QTranslator[] = {{172, 255, 1}};
