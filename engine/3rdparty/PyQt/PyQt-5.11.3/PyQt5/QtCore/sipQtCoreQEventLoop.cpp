...
PyDoc_STRVAR(doc_QEventLoop_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QEventLoop_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QEventLoop_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QEventLoop_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QEventLoop_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QEventLoop_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QEventLoop_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QEventLoop_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QEventLoop_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QEventLoop[] = {{172, 255, 1}};
...
static sipEnumMemberDef enummembers_QEventLoop[] = {
    {sipName_AllEvents, static_cast<int>( ::QEventLoop::AllEvents), 62},
    {sipName_ExcludeSocketNotifiers, static_cast<int>( ::QEventLoop::ExcludeSocketNotifiers), 62},
    {sipName_ExcludeUserInputEvents, static_cast<int>( ::QEventLoop::ExcludeUserInputEvents), 62},
    {sipName_WaitForMoreEvents, static_cast<int>( ::QEventLoop::WaitForMoreEvents), 62},
    {sipName_X11ExcludeTimers, static_cast<int>( ::QEventLoop::X11ExcludeTimers), 62},
};
