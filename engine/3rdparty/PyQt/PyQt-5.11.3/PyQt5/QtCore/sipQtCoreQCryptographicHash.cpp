...
static sipEnumMemberDef enummembers_QCryptographicHash[] = {
    {sipName_Keccak_224, static_cast<int>( ::QCryptographicHash::Keccak_224), 35},
    {sipName_Keccak_256, static_cast<int>( ::QCryptographicHash::Keccak_256), 35},
    {sipName_Keccak_384, static_cast<int>( ::QCryptographicHash::Keccak_384), 35},
    {sipName_Keccak_512, static_cast<int>( ::QCryptographicHash::Keccak_512), 35},
    {sipName_Md4, static_cast<int>( ::QCryptographicHash::Md4), 35},
    {sipName_Md5, static_cast<int>( ::QCryptographicHash::Md5), 35},
    {sipName_Sha1, static_cast<int>( ::QCryptographicHash::Sha1), 35},
    {sipName_Sha224, static_cast<int>( ::QCryptographicHash::Sha224), 35},
    {sipName_Sha256, static_cast<int>( ::QCryptographicHash::Sha256), 35},
    {sipName_Sha384, static_cast<int>( ::QCryptographicHash::Sha384), 35},
    {sipName_Sha3_224, static_cast<int>( ::QCryptographicHash::Sha3_224), 35},
    {sipName_Sha3_256, static_cast<int>( ::QCryptographicHash::Sha3_256), 35},
    {sipName_Sha3_384, static_cast<int>( ::QCryptographicHash::Sha3_384), 35},
    {sipName_Sha3_512, static_cast<int>( ::QCryptographicHash::Sha3_512), 35},
    {sipName_Sha512, static_cast<int>( ::QCryptographicHash::Sha512), 35},
};
