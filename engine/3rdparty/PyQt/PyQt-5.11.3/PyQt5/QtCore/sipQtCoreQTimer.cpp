...
PyDoc_STRVAR(doc_QTimer_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QTimer_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QTimer_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QTimer_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QTimer_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTimer_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QTimer_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QTimer_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QTimer[] = {{172, 255, 1}};
