...
PyDoc_STRVAR(doc_QAbstractItemModel_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QAbstractItemModel_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QAbstractItemModel_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QAbstractItemModel_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QAbstractItemModel_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QAbstractItemModel_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QAbstractItemModel_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QAbstractItemModel_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QAbstractItemModel_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QAbstractItemModel[] = {{172, 255, 1}};
