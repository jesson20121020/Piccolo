...
PyDoc_STRVAR(doc_QDeadlineTimer_setRemainingTime, "setRemainingTime(self, int, type: Qt.TimerType = Qt.TimerType.CoarseTimer)");
...
static PyObject *meth_QDeadlineTimer_setRemainingTime(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    {
         ::qint64 a0;
         ::Qt::TimerType a1 = Qt::TimerType::CoarseTimer;
         ::QDeadlineTimer *sipCpp;
...
PyDoc_STRVAR(doc_QDeadlineTimer_setPreciseRemainingTime, "setPreciseRemainingTime(self, int, nsecs: int = 0, type: Qt.TimerType = Qt.TimerType.CoarseTimer)");
...
static PyObject *meth_QDeadlineTimer_setPreciseRemainingTime(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
         ::qint64 a0;
         ::qint64 a1 = 0;
         ::Qt::TimerType a2 = Qt::TimerType::CoarseTimer;
         ::QDeadlineTimer *sipCpp;
...
PyDoc_STRVAR(doc_QDeadlineTimer_setDeadline, "setDeadline(self, int, type: Qt.TimerType = Qt.TimerType.CoarseTimer)");
...
PyDoc_STRVAR(doc_QDeadlineTimer_setPreciseDeadline, "setPreciseDeadline(self, int, nsecs: int = 0, type: Qt.TimerType = Qt.TimerType.CoarseTimer)");
...
PyDoc_STRVAR(doc_QDeadlineTimer_current, "current(type: Qt.TimerType = Qt.TimerType.CoarseTimer) -> QDeadlineTimer");
...
static PyObject *meth_QDeadlineTimer_current(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    {
         ::Qt::TimerType a0 = Qt::TimerType::CoarseTimer;
...
static sipEnumMemberDef enummembers_QDeadlineTimer[] = {
    {sipName_Forever, static_cast<int>( ::QDeadlineTimer::Forever), 45},
};

PyDoc_STRVAR(doc_QDeadlineTimer, "\1QDeadlineTimer(type: Qt.TimerType = Qt.TimerType.CoarseTimer)\n"
