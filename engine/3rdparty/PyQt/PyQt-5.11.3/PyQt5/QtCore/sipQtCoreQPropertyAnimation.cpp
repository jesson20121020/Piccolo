...
PyDoc_STRVAR(doc_QPropertyAnimation_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QPropertyAnimation_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QPropertyAnimation_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QPropertyAnimation_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QPropertyAnimation_updateDirection, "updateDirection(self, QAbstractAnimation.Direction)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_updateCurrentTime, "updateCurrentTime(self, int)");
...
PyDoc_STRVAR(doc_QPropertyAnimation_interpolated, "interpolated(self, Any, Any, float) -> Any");
...
static sipEncodedTypeDef supers_QPropertyAnimation[] = {{303, 255, 1}};
