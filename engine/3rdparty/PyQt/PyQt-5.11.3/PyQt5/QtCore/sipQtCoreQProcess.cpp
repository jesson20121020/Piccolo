...
PyDoc_STRVAR(doc_QProcess_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QProcess_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QProcess_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QProcess_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QProcess_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QProcess_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QProcess_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QProcess_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QProcess_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QProcess_readLineData, "readLineData(self, int) -> str");
...
PyDoc_STRVAR(doc_QProcess_setOpenMode, "setOpenMode(self, Union[QIODevice.OpenMode, QIODevice.OpenModeFlag])");
...
PyDoc_STRVAR(doc_QProcess_setErrorString, "setErrorString(self, str)");
...
PyDoc_STRVAR(doc_QProcess_pid, "pid(self) -> sip.voidptr");
...
static sipEncodedTypeDef supers_QProcess[] = {{85, 255, 1}};
...
static sipEnumMemberDef enummembers_QProcess[] = {
    {sipName_CrashExit, static_cast<int>( ::QProcess::CrashExit), 184},
    {sipName_Crashed, static_cast<int>( ::QProcess::Crashed), 188},
    {sipName_FailedToStart, static_cast<int>( ::QProcess::FailedToStart), 188},
    {sipName_ForwardedChannels, static_cast<int>( ::QProcess::ForwardedChannels), 187},
    {sipName_ForwardedErrorChannel, static_cast<int>( ::QProcess::ForwardedErrorChannel), 187},
    {sipName_ForwardedInputChannel, static_cast<int>( ::QProcess::ForwardedInputChannel), 185},
    {sipName_ForwardedOutputChannel, static_cast<int>( ::QProcess::ForwardedOutputChannel), 187},
    {sipName_ManagedInputChannel, static_cast<int>( ::QProcess::ManagedInputChannel), 185},
    {sipName_MergedChannels, static_cast<int>( ::QProcess::MergedChannels), 187},
    {sipName_NormalExit, static_cast<int>( ::QProcess::NormalExit), 184},
    {sipName_NotRunning, static_cast<int>( ::QProcess::NotRunning), 189},
    {sipName_ReadError, static_cast<int>( ::QProcess::ReadError), 188},
    {sipName_Running, static_cast<int>( ::QProcess::Running), 189},
    {sipName_SeparateChannels, static_cast<int>( ::QProcess::SeparateChannels), 187},
    {sipName_StandardError, static_cast<int>( ::QProcess::StandardError), 186},
    {sipName_StandardOutput, static_cast<int>( ::QProcess::StandardOutput), 186},
    {sipName_Starting, static_cast<int>( ::QProcess::Starting), 189},
    {sipName_Timedout, static_cast<int>( ::QProcess::Timedout), 188},
    {sipName_UnknownError, static_cast<int>( ::QProcess::UnknownError), 188},
    {sipName_WriteError, static_cast<int>( ::QProcess::WriteError), 188},
};
...
static const pyqt5QtSignal signals_QProcess[] = {
    ...
    {"error(QProcess::ProcessError)", "\1error(self, QProcess.ProcessError)", &methods_QProcess[12], 0},
    {0, 0, 0, 0}
};
