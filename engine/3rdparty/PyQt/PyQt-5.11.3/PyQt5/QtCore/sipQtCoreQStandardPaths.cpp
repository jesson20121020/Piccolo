...
static sipEnumMemberDef enummembers_QStandardPaths[] = {
    {sipName_AppConfigLocation, static_cast<int>( ::QStandardPaths::AppConfigLocation), 234},
    {sipName_AppDataLocation, static_cast<int>( ::QStandardPaths::AppDataLocation), 234},
    {sipName_AppLocalDataLocation, static_cast<int>( ::QStandardPaths::AppLocalDataLocation), 234},
    {sipName_ApplicationsLocation, static_cast<int>( ::QStandardPaths::ApplicationsLocation), 234},
    {sipName_CacheLocation, static_cast<int>( ::QStandardPaths::CacheLocation), 234},
    {sipName_ConfigLocation, static_cast<int>( ::QStandardPaths::ConfigLocation), 234},
    {sipName_DataLocation, static_cast<int>( ::QStandardPaths::DataLocation), 234},
    {sipName_DesktopLocation, static_cast<int>( ::QStandardPaths::DesktopLocation), 234},
    {sipName_DocumentsLocation, static_cast<int>( ::QStandardPaths::DocumentsLocation), 234},
    {sipName_DownloadLocation, static_cast<int>( ::QStandardPaths::DownloadLocation), 234},
    {sipName_FontsLocation, static_cast<int>( ::QStandardPaths::FontsLocation), 234},
    {sipName_GenericCacheLocation, static_cast<int>( ::QStandardPaths::GenericCacheLocation), 234},
    {sipName_GenericConfigLocation, static_cast<int>( ::QStandardPaths::GenericConfigLocation), 234},
    {sipName_GenericDataLocation, static_cast<int>( ::QStandardPaths::GenericDataLocation), 234},
    {sipName_HomeLocation, static_cast<int>( ::QStandardPaths::HomeLocation), 234},
    {sipName_LocateDirectory, static_cast<int>( ::QStandardPaths::LocateDirectory), 232},
    {sipName_LocateFile, static_cast<int>( ::QStandardPaths::LocateFile), 232},
    {sipName_MoviesLocation, static_cast<int>( ::QStandardPaths::MoviesLocation), 234},
    {sipName_MusicLocation, static_cast<int>( ::QStandardPaths::MusicLocation), 234},
    {sipName_PicturesLocation, static_cast<int>( ::QStandardPaths::PicturesLocation), 234},
    {sipName_RuntimeLocation, static_cast<int>( ::QStandardPaths::RuntimeLocation), 234},
    {sipName_TempLocation, static_cast<int>( ::QStandardPaths::TempLocation), 234},
};
