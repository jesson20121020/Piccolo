...
PyDoc_STRVAR(doc_QStateMachine_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QStateMachine_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QStateMachine_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QStateMachine_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QStateMachine_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QStateMachine_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QStateMachine_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QStateMachine_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QStateMachine_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QStateMachine[] = {{235, 255, 1}};
...
static sipEnumMemberDef enummembers_QStateMachine[] = {
    {sipName_HighPriority, static_cast<int>( ::QStateMachine::HighPriority), 240},
    {sipName_NoCommonAncestorForTransitionError, static_cast<int>( ::QStateMachine::NoCommonAncestorForTransitionError), 239},
    {sipName_NoDefaultStateInHistoryStateError, static_cast<int>( ::QStateMachine::NoDefaultStateInHistoryStateError), 239},
    {sipName_NoError, static_cast<int>( ::QStateMachine::NoError), 239},
    {sipName_NoInitialStateError, static_cast<int>( ::QStateMachine::NoInitialStateError), 239},
    {sipName_NormalPriority, static_cast<int>( ::QStateMachine::NormalPriority), 240},
};
