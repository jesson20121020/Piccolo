...
static sipEnumMemberDef enummembers_QElapsedTimer[] = {
    {sipName_MachAbsoluteTime, static_cast<int>( ::QElapsedTimer::MachAbsoluteTime), 58},
    {sipName_MonotonicClock, static_cast<int>( ::QElapsedTimer::MonotonicClock), 58},
    {sipName_PerformanceCounter, static_cast<int>( ::QElapsedTimer::PerformanceCounter), 58},
    {sipName_SystemTime, static_cast<int>( ::QElapsedTimer::SystemTime), 58},
    {sipName_TickCounter, static_cast<int>( ::QElapsedTimer::TickCounter), 58},
};
