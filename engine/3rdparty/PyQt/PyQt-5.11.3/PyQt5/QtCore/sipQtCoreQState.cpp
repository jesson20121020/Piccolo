...
PyDoc_STRVAR(doc_QState_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QState_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QState_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QState_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QState_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QState_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QState_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QState_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QState_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEnumMemberDef enummembers_QState[] = {
    {sipName_DontRestoreProperties, static_cast<int>( ::QState::DontRestoreProperties), 237},
    {sipName_ExclusiveStates, static_cast<int>( ::QState::ExclusiveStates), 236},
    {sipName_ParallelStates, static_cast<int>( ::QState::ParallelStates), 236},
    {sipName_RestoreProperties, static_cast<int>( ::QState::RestoreProperties), 237},
};
