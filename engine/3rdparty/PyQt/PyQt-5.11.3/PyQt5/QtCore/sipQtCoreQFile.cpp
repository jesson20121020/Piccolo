...
PyDoc_STRVAR(doc_QFile_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QFile_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QFile_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QFile_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QFile_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QFile_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFile_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFile_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QFile_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
PyDoc_STRVAR(doc_QFile_setOpenMode, "setOpenMode(self, Union[QIODevice.OpenMode, QIODevice.OpenModeFlag])");
...
PyDoc_STRVAR(doc_QFile_setErrorString, "setErrorString(self, str)");
...
static sipEncodedTypeDef supers_QFile[] = {{67, 255, 1}};
