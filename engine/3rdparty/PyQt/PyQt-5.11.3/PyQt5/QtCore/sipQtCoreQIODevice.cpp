...
PyDoc_STRVAR(doc_QIODevice_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QIODevice_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QIODevice_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QIODevice_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QIODevice_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QIODevice_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QIODevice_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QIODevice_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QIODevice_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QIODevice[] = {{172, 255, 1}};
...
static sipEnumMemberDef enummembers_QIODevice[] = {
    {sipName_Append, static_cast<int>( ::QIODevice::Append), 87},
    {sipName_NotOpen, static_cast<int>( ::QIODevice::NotOpen), 87},
    {sipName_ReadOnly, static_cast<int>( ::QIODevice::ReadOnly), 87},
    {sipName_ReadWrite, static_cast<int>( ::QIODevice::ReadWrite), 87},
    {sipName_Text, static_cast<int>( ::QIODevice::Text), 87},
    {sipName_Truncate, static_cast<int>( ::QIODevice::Truncate), 87},
    {sipName_Unbuffered, static_cast<int>( ::QIODevice::Unbuffered), 87},
    {sipName_WriteOnly, static_cast<int>( ::QIODevice::WriteOnly), 87},
};
