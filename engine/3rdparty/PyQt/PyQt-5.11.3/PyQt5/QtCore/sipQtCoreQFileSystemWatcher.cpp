...
PyDoc_STRVAR(doc_QFileSystemWatcher_sender, "sender(self) -> QObject");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_receivers, "receivers(self, PYQT_SIGNAL) -> int");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_timerEvent, "timerEvent(self, QTimerEvent)");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_childEvent, "childEvent(self, QChildEvent)");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_customEvent, "customEvent(self, QEvent)");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_connectNotify, "connectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_disconnectNotify, "disconnectNotify(self, QMetaMethod)");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_senderSignalIndex, "senderSignalIndex(self) -> int");
...
PyDoc_STRVAR(doc_QFileSystemWatcher_isSignalConnected, "isSignalConnected(self, QMetaMethod) -> bool");
...
static sipEncodedTypeDef supers_QFileSystemWatcher[] = {{172, 255, 1}};
