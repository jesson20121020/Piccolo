...
static PyObject *meth_QDir_isEmpty(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|J1", &sipSelf, sipType_QDir, &sipCpp, sipType_QDir_Filters, &a0, &a0State))
        {
            bool sipRes;
...
static PyMethodDef methods_QDir[] = {
    ...
    {SIP_MLNAME_CAST(sipName_isEmpty), (PyCFunction)meth_QDir_isEmpty, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QDir_isEmpty)},
...
static sipEnumMemberDef enummembers_QDir[] = {
    {sipName_AccessMask, static_cast<int>( ::QDir::AccessMask), 47},
    {sipName_AllDirs, static_cast<int>( ::QDir::AllDirs), 47},
    {sipName_AllEntries, static_cast<int>( ::QDir::AllEntries), 47},
    {sipName_CaseSensitive, static_cast<int>( ::QDir::CaseSensitive), 47},
    {sipName_Dirs, static_cast<int>( ::QDir::Dirs), 47},
    {sipName_DirsFirst, static_cast<int>( ::QDir::DirsFirst), 49},
    {sipName_DirsLast, static_cast<int>( ::QDir::DirsLast), 49},
    {sipName_Drives, static_cast<int>( ::QDir::Drives), 47},
    {sipName_Executable, static_cast<int>( ::QDir::Executable), 47},
    {sipName_Files, static_cast<int>( ::QDir::Files), 47},
    {sipName_Hidden, static_cast<int>( ::QDir::Hidden), 47},
    {sipName_IgnoreCase, static_cast<int>( ::QDir::IgnoreCase), 49},
    {sipName_LocaleAware, static_cast<int>( ::QDir::LocaleAware), 49},
    {sipName_Modified, static_cast<int>( ::QDir::Modified), 47},
    {sipName_Name, static_cast<int>( ::QDir::Name), 49},
    {sipName_NoDot, static_cast<int>( ::QDir::NoDot), 47},
    {sipName_NoDotAndDotDot, static_cast<int>( ::QDir::NoDotAndDotDot), 47},
    {sipName_NoDotDot, static_cast<int>( ::QDir::NoDotDot), 47},
    {sipName_NoFilter, static_cast<int>( ::QDir::NoFilter), 47},
    {sipName_NoSort, static_cast<int>( ::QDir::NoSort), 49},
    {sipName_NoSymLinks, static_cast<int>( ::QDir::NoSymLinks), 47},
    {sipName_PermissionMask, static_cast<int>( ::QDir::PermissionMask), 47},
    {sipName_Readable, static_cast<int>( ::QDir::Readable), 47},
    {sipName_Reversed, static_cast<int>( ::QDir::Reversed), 49},
    {sipName_Size, static_cast<int>( ::QDir::Size), 49},
    {sipName_SortByMask, static_cast<int>( ::QDir::SortByMask), 49},
    {sipName_System, static_cast<int>( ::QDir::System), 47},
    {sipName_Time, static_cast<int>( ::QDir::Time), 49},
    {sipName_Type, static_cast<int>( ::QDir::Type), 49},
    {sipName_TypeMask, static_cast<int>( ::QDir::TypeMask), 47},
    {sipName_Unsorted, static_cast<int>( ::QDir::Unsorted), 49},
    {sipName_Writable, static_cast<int>( ::QDir::Writable), 47},
};
