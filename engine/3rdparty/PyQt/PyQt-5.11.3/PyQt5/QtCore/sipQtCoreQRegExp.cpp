...
static sipEnumMemberDef enummembers_QRegExp[] = {
    {sipName_CaretAtOffset, static_cast<int>( ::QRegExp::CaretAtOffset), 199},
    {sipName_CaretAtZero, static_cast<int>( ::QRegExp::CaretAtZero), 199},
    {sipName_CaretWontMatch, static_cast<int>( ::QRegExp::CaretWontMatch), 199},
    {sipName_FixedString, static_cast<int>( ::QRegExp::FixedString), 200},
    {sipName_RegExp, static_cast<int>( ::QRegExp::RegExp), 200},
    {sipName_RegExp2, static_cast<int>( ::QRegExp::RegExp2), 200},
    {sipName_W3CXmlSchema11, static_cast<int>( ::QRegExp::W3CXmlSchema11), 200},
    {sipName_Wildcard, static_cast<int>( ::QRegExp::Wildcard), 200},
    {sipName_WildcardUnix, static_cast<int>( ::QRegExp::WildcardUnix), 200},
};
