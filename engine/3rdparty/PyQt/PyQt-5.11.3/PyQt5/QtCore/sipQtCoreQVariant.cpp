...
static sipEnumMemberDef enummembers_QVariant[] = {
    {sipName_BitArray, static_cast<int>( ::QVariant::BitArray), 302},
    {sipName_Bitmap, static_cast<int>( ::QVariant::Bitmap), 302},
    {sipName_Bool, static_cast<int>( ::QVariant::Bool), 302},
    {sipName_Brush, static_cast<int>( ::QVariant::Brush), 302},
    {sipName_ByteArray, static_cast<int>( ::QVariant::ByteArray), 302},
    {sipName_Char, static_cast<int>( ::QVariant::Char), 302},
    {sipName_Color, static_cast<int>( ::QVariant::Color), 302},
    {sipName_Cursor, static_cast<int>( ::QVariant::Cursor), 302},
    {sipName_Date, static_cast<int>( ::QVariant::Date), 302},
    {sipName_DateTime, static_cast<int>( ::QVariant::DateTime), 302},
    {sipName_Double, static_cast<int>( ::QVariant::Double), 302},
    {sipName_EasingCurve, static_cast<int>( ::QVariant::EasingCurve), 302},
    {sipName_Font, static_cast<int>( ::QVariant::Font), 302},
    {sipName_Hash, static_cast<int>( ::QVariant::Hash), 302},
    {sipName_Icon, static_cast<int>( ::QVariant::Icon), 302},
    {sipName_Image, static_cast<int>( ::QVariant::Image), 302},
    {sipName_Int, static_cast<int>( ::QVariant::Int), 302},
    {sipName_Invalid, static_cast<int>( ::QVariant::Invalid), 302},
    {sipName_KeySequence, static_cast<int>( ::QVariant::KeySequence), 302},
    {sipName_Line, static_cast<int>( ::QVariant::Line), 302},
    {sipName_LineF, static_cast<int>( ::QVariant::LineF), 302},
    {sipName_List, static_cast<int>( ::QVariant::List), 302},
    {sipName_Locale, static_cast<int>( ::QVariant::Locale), 302},
    {sipName_LongLong, static_cast<int>( ::QVariant::LongLong), 302},
    {sipName_Map, static_cast<int>( ::QVariant::Map), 302},
    {sipName_Matrix, static_cast<int>( ::QVariant::Matrix), 302},
    {sipName_Matrix4x4, static_cast<int>( ::QVariant::Matrix4x4), 302},
    {sipName_ModelIndex, static_cast<int>( ::QVariant::ModelIndex), 302},
    {sipName_Palette, static_cast<int>( ::QVariant::Palette), 302},
    {sipName_Pen, static_cast<int>( ::QVariant::Pen), 302},
    {sipName_PersistentModelIndex, static_cast<int>( ::QVariant::PersistentModelIndex), 302},
    {sipName_Pixmap, static_cast<int>( ::QVariant::Pixmap), 302},
    {sipName_Point, static_cast<int>( ::QVariant::Point), 302},
    {sipName_PointF, static_cast<int>( ::QVariant::PointF), 302},
    {sipName_Polygon, static_cast<int>( ::QVariant::Polygon), 302},
    {sipName_PolygonF, static_cast<int>( ::QVariant::PolygonF), 302},
    {sipName_Quaternion, static_cast<int>( ::QVariant::Quaternion), 302},
    {sipName_Rect, static_cast<int>( ::QVariant::Rect), 302},
    {sipName_RectF, static_cast<int>( ::QVariant::RectF), 302},
    {sipName_RegExp, static_cast<int>( ::QVariant::RegExp), 302},
    {sipName_Region, static_cast<int>( ::QVariant::Region), 302},
    {sipName_RegularExpression, static_cast<int>( ::QVariant::RegularExpression), 302},
    {sipName_Size, static_cast<int>( ::QVariant::Size), 302},
    {sipName_SizeF, static_cast<int>( ::QVariant::SizeF), 302},
    {sipName_SizePolicy, static_cast<int>( ::QVariant::SizePolicy), 302},
    {sipName_String, static_cast<int>( ::QVariant::String), 302},
    {sipName_StringList, static_cast<int>( ::QVariant::StringList), 302},
    {sipName_TextFormat, static_cast<int>( ::QVariant::TextFormat), 302},
    {sipName_TextLength, static_cast<int>( ::QVariant::TextLength), 302},
    {sipName_Time, static_cast<int>( ::QVariant::Time), 302},
    {sipName_Transform, static_cast<int>( ::QVariant::Transform), 302},
    {sipName_UInt, static_cast<int>( ::QVariant::UInt), 302},
    {sipName_ULongLong, static_cast<int>( ::QVariant::ULongLong), 302},
    {sipName_Url, static_cast<int>( ::QVariant::Url), 302},
    {sipName_UserType, static_cast<int>( ::QVariant::UserType), 302},
    {sipName_Uuid, static_cast<int>( ::QVariant::Uuid), 302},
    {sipName_Vector2D, static_cast<int>( ::QVariant::Vector2D), 302},
    {sipName_Vector3D, static_cast<int>( ::QVariant::Vector3D), 302},
    {sipName_Vector4D, static_cast<int>( ::QVariant::Vector4D), 302},
};
