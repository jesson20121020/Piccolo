...
static sipEnumMemberDef enummembers_QUrl[] = {
    {sipName_AssumeLocalFile, static_cast<int>( ::QUrl::AssumeLocalFile), 295},
    {sipName_DecodeReserved, static_cast<int>( ::QUrl::DecodeReserved), 290},
    {sipName_DecodedMode, static_cast<int>( ::QUrl::DecodedMode), 293},
    {sipName_DefaultResolution, static_cast<int>( ::QUrl::DefaultResolution), 295},
    {sipName_EncodeDelimiters, static_cast<int>( ::QUrl::EncodeDelimiters), 290},
    {sipName_EncodeReserved, static_cast<int>( ::QUrl::EncodeReserved), 290},
    {sipName_EncodeSpaces, static_cast<int>( ::QUrl::EncodeSpaces), 290},
    {sipName_EncodeUnicode, static_cast<int>( ::QUrl::EncodeUnicode), 290},
    {sipName_FullyDecoded, static_cast<int>( ::QUrl::FullyDecoded), 290},
    {sipName_FullyEncoded, static_cast<int>( ::QUrl::FullyEncoded), 290},
    {sipName_None_, static_cast<int>( ::QUrl::None), 294},
    {sipName_NormalizePathSegments, static_cast<int>( ::QUrl::NormalizePathSegments), 294},
    {sipName_PreferLocalFile, static_cast<int>( ::QUrl::PreferLocalFile), 294},
    {sipName_PrettyDecoded, static_cast<int>( ::QUrl::PrettyDecoded), 290},
    {sipName_RemoveAuthority, static_cast<int>( ::QUrl::RemoveAuthority), 294},
    {sipName_RemoveFilename, static_cast<int>( ::QUrl::RemoveFilename), 294},
    {sipName_RemoveFragment, static_cast<int>( ::QUrl::RemoveFragment), 294},
    {sipName_RemovePassword, static_cast<int>( ::QUrl::RemovePassword), 294},
    {sipName_RemovePath, static_cast<int>( ::QUrl::RemovePath), 294},
    {sipName_RemovePort, static_cast<int>( ::QUrl::RemovePort), 294},
    {sipName_RemoveQuery, static_cast<int>( ::QUrl::RemoveQuery), 294},
    {sipName_RemoveScheme, static_cast<int>( ::QUrl::RemoveScheme), 294},
    {sipName_RemoveUserInfo, static_cast<int>( ::QUrl::RemoveUserInfo), 294},
    {sipName_StrictMode, static_cast<int>( ::QUrl::StrictMode), 293},
    {sipName_StripTrailingSlash, static_cast<int>( ::QUrl::StripTrailingSlash), 294},
    {sipName_TolerantMode, static_cast<int>( ::QUrl::TolerantMode), 293},
};
