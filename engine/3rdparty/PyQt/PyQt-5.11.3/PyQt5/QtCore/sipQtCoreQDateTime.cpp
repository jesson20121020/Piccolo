...
static PyObject *meth_QDateTime_fromSecsSinceEpoch(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "n|Ei", &a0, sipType_Qt_TimeSpec, &a1, &a2))
        {
             ::QDateTime*sipRes;
...
static PyMethodDef methods_QDateTime[] = {
    ...
    {SIP_MLNAME_CAST(sipName_fromSecsSinceEpoch), (PyCFunction)meth_QDateTime_fromSecsSinceEpoch, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QDateTime_fromSecsSinceEpoch)},
